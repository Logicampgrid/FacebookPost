...
- **Webhook Enhanced**: `https://social-login-app.preview.emergentagent.com/api/webhook/enhanced`
- **Documentation**: `https://social-login-app.preview.emergentagent.com/api/webhook/enhanced` (GET)
- **Interface Web**: `https://social-login-app.preview.emergentagent.com`
