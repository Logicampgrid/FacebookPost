...
### **Interface Web**
1. Connectez-vous à https://ngrok-uri-sync.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ngrok-uri-sync.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ngrok-uri-sync.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
