...
### **Interface Web**
1. Connectez-vous à https://patch-master-8.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://patch-master-8.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://patch-master-8.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
