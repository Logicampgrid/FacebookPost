...
### **Interface Web**
1. Connectez-vous à https://product-image-link-1.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://product-image-link-1.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://product-image-link-1.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://product-image-link-1.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
