...
### **Interface Web**
1. Connectez-vous à https://ok-system-7.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ok-system-7.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://ok-system-7.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://ok-system-7.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
