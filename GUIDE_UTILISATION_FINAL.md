...
### **Interface Web**
1. Connectez-vous à https://token-exchange-5.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://token-exchange-5.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://token-exchange-5.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
