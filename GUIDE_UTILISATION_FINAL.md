...
### **Interface Web**
1. Connectez-vous à https://hors-instagram.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://hors-instagram.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://hors-instagram.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
