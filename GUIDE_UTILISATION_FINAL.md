...
### **Interface Web**
1. Connectez-vous à https://fastapi-oauth.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fastapi-oauth.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fastapi-oauth.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
