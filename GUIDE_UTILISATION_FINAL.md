...
### **Interface Web**
1. Connectez-vous à https://bbs-video-post.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://bbs-video-post.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://bbs-video-post.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
