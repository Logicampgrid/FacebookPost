...
### **Interface Web**
1. Connectez-vous à https://berger-blanc-suisse.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://berger-blanc-suisse.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://berger-blanc-suisse.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
