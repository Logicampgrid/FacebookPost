...
### **Interface Web**
1. Connectez-vous à https://photo-path-converter.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://photo-path-converter.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://photo-path-converter.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
