...
### **Interface Web**
1. Connectez-vous à https://local-oauth-proxy.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://local-oauth-proxy.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://local-oauth-proxy.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
