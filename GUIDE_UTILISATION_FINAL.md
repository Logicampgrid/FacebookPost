...
### **Interface Web**
1. Connectez-vous à https://webhoek-next.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://webhoek-next.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://webhoek-next.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
