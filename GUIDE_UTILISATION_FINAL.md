...
### **Interface Web**
1. Connectez-vous à https://continue-app-45.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://continue-app-45.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://continue-app-45.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
