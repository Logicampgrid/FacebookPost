...
### **Interface Web**
1. Connectez-vous à https://meta-vid-uploader.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://meta-vid-uploader.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://meta-vid-uploader.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
