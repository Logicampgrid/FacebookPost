...
### **Interface Web**
1. Connectez-vous à https://login-gateway-fix.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://login-gateway-fix.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://login-gateway-fix.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
