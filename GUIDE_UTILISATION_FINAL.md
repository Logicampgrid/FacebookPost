...
### **Interface Web**
1. Connectez-vous à https://gizmobbs-shop.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://gizmobbs-shop.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://gizmobbs-shop.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://gizmobbs-shop.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
