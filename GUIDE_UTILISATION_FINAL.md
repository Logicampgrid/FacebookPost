...
### **Interface Web**
1. Connectez-vous à https://webpub-debug.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://webpub-debug.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://webpub-debug.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
