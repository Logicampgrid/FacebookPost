...
### **Interface Web**
1. Connectez-vous à https://promptbot-1.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://promptbot-1.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://promptbot-1.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
