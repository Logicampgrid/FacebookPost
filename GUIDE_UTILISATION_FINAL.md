...
### **Interface Web**
1. Connectez-vous à https://instapost-update.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://instapost-update.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://instapost-update.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
