...
### **Interface Web**
1. Connectez-vous à https://ok-simple-19.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ok-simple-19.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ok-simple-19.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
