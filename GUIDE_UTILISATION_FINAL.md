...
### **Interface Web**
1. Connectez-vous à https://auto-post-ig.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://auto-post-ig.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://auto-post-ig.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
