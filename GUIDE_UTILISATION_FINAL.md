...
### **Interface Web**
1. Connectez-vous à https://auto-ngrok-updater.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://auto-ngrok-updater.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://auto-ngrok-updater.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
