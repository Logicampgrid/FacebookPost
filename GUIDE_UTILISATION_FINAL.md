...
### **Interface Web**
1. Connectez-vous à https://offline-lifestyle.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://offline-lifestyle.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://offline-lifestyle.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
