...
### **Interface Web**
1. Connectez-vous à https://next-steps-55.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://next-steps-55.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://next-steps-55.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
