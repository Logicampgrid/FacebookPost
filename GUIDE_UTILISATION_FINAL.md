...
### **Interface Web**
1. Connectez-vous à https://frontend-access.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://frontend-access.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://frontend-access.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
