...
### **Interface Web**
1. Connectez-vous à https://oauth-frontend-fix.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://oauth-frontend-fix.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://oauth-frontend-fix.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://oauth-frontend-fix.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
