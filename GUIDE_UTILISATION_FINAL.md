...
### **Interface Web**
1. Connectez-vous à https://crosspost-oauth.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://crosspost-oauth.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://crosspost-oauth.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
