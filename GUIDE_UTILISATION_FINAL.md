...
### **Interface Web**
1. Connectez-vous à https://dynamic-preview.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://dynamic-preview.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://dynamic-preview.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
