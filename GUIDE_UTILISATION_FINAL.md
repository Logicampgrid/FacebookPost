...
### **Interface Web**
1. Connectez-vous à https://file-webhook-api.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://file-webhook-api.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://file-webhook-api.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
