...
### **Interface Web**
1. Connectez-vous à https://meta-post-manager.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://meta-post-manager.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://meta-post-manager.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://meta-post-manager.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
