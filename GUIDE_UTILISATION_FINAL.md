...
### **Interface Web**
1. Connectez-vous à https://feed-link-update.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://feed-link-update.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://feed-link-update.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
