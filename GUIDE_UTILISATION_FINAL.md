...
### **Interface Web**
1. Connectez-vous à https://fb-static-api.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fb-static-api.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fb-static-api.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
