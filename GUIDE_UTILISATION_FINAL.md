...
### **Interface Web**
1. Connectez-vous à https://media-upload-fix-3.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://media-upload-fix-3.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://media-upload-fix-3.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://media-upload-fix-3.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
