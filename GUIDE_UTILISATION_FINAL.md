...
### **API Directe**
```bash
GET https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
