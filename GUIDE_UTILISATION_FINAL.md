...
### **Interface Web**
1. Connectez-vous à https://ngrokdetector.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ngrokdetector.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ngrokdetector.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
