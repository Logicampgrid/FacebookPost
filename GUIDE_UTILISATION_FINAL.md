...
### **Interface Web**
1. Connectez-vous à https://backend-alignment.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://backend-alignment.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://backend-alignment.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
