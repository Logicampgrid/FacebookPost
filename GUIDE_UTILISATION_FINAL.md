...
### **Interface Web**
1. Connectez-vous à https://berger-media-bug.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://berger-media-bug.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://berger-media-bug.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
