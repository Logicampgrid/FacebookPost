...
### **Interface Web**
1. Connectez-vous à https://prompt-enhance-5.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://prompt-enhance-5.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://prompt-enhance-5.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
