...
### **Interface Web**
1. Connectez-vous à https://prompt-emergence.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://prompt-emergence.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://prompt-emergence.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
