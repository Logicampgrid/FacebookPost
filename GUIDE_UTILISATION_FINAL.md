...
### **Interface Web**
1. Connectez-vous à https://code-wizard-34.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://code-wizard-34.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://code-wizard-34.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
