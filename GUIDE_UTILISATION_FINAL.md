...
### **Interface Web**
1. Connectez-vous à https://json-repair.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://json-repair.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://json-repair.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
