...
### **Interface Web**
1. Connectez-vous à https://fb-post-backend.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fb-post-backend.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fb-post-backend.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
