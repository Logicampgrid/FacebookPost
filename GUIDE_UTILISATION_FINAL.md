...
### **Interface Web**
1. Connectez-vous à https://dev-assistant-fb.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://dev-assistant-fb.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://dev-assistant-fb.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
