...
### **Interface Web**
1. Connectez-vous à https://bugfix-login.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://bugfix-login.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://bugfix-login.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
