...
### **Interface Web**
1. Connectez-vous à https://emergentech-pro.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://emergentech-pro.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://emergentech-pro.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
