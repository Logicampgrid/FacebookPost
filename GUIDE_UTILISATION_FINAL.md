...
### **Interface Web**
1. Connectez-vous à https://image-ftp-insta.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://image-ftp-insta.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://image-ftp-insta.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
