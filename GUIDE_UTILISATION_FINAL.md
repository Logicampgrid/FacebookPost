...
### **Interface Web**
1. Connectez-vous à https://social-sync-tool.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://social-sync-tool.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://social-sync-tool.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
