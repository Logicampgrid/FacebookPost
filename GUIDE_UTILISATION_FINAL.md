...
### **Interface Web**
1. Connectez-vous à https://fbpost-tunnel-1.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fbpost-tunnel-1.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fbpost-tunnel-1.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
