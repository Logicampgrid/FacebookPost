...
### **Interface Web**
1. Connectez-vous à https://media-uploader-6.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://media-uploader-6.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://media-uploader-6.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
