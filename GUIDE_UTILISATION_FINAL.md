...
### **Interface Web**
1. Connectez-vous à https://fbpost-backfix.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fbpost-backfix.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fbpost-backfix.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
