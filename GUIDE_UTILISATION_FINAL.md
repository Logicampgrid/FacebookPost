...
### **Interface Web**
1. Connectez-vous à https://webhook-consolidate.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://webhook-consolidate.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://webhook-consolidate.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
