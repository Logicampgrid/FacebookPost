...
### **Interface Web**
1. Connectez-vous à https://bbs-media-poster.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://bbs-media-poster.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://bbs-media-poster.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
