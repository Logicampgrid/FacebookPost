...
### **Interface Web**
1. Connectez-vous à https://better-prompt.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://better-prompt.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://better-prompt.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
