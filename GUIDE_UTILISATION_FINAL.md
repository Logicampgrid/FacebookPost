...
### **Interface Web**
1. Connectez-vous à https://content-sync-app.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://content-sync-app.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://content-sync-app.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
