...
### **Interface Web**
1. Connectez-vous à https://invalid-object-fix.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://invalid-object-fix.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://invalid-object-fix.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
