...
### **Interface Web**
1. Connectez-vous à https://emergentsh-boost.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://emergentsh-boost.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://emergentsh-boost.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
