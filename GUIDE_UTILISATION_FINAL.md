...
### **Interface Web**
1. Connectez-vous à https://smart-fb-poster.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://smart-fb-poster.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://smart-fb-poster.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
