...
### **Interface Web**
1. Connectez-vous à https://image-upload-fix-5.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://image-upload-fix-5.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://image-upload-fix-5.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
