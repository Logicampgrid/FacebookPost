...
### **Interface Web**
1. Connectez-vous à https://finish-line-13.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://finish-line-13.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://finish-line-13.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
