...
### **Interface Web**
1. Connectez-vous à https://dual-boutique.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://dual-boutique.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://dual-boutique.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
