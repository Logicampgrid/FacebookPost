...
### **API Directe**
```bash
GET https://keep-going-235.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://keep-going-235.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
