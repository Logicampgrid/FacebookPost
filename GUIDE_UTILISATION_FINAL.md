...
### **Interface Web**
1. Connectez-vous à https://instagram-upload.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://instagram-upload.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://instagram-upload.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
