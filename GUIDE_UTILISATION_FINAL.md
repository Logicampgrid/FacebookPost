...
### **Interface Web**
1. Connectez-vous à https://social-media-bridge.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://social-media-bridge.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://social-media-bridge.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
