...
### **Interface Web**
1. Connectez-vous à https://emergent-builder-9.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://emergent-builder-9.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://emergent-builder-9.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
