...
### **Interface Web**
1. Connectez-vous à https://social-commerce-hub-1.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://social-commerce-hub-1.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://social-commerce-hub-1.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
