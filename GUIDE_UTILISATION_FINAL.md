...
### **Interface Web**
1. Connectez-vous à https://ok-demo-4.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ok-demo-4.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ok-demo-4.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
