...
### **Interface Web**
1. Connectez-vous à https://redirect-domain-fix.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://redirect-domain-fix.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://redirect-domain-fix.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
