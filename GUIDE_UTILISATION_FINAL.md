...
### **Interface Web**
1. Connectez-vous à https://keep-going-238.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://keep-going-238.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://keep-going-238.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
