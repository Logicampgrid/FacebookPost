...
### **Interface Web**
1. Connectez-vous à https://ok-minimal.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ok-minimal.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ok-minimal.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
