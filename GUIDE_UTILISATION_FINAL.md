...
### **Interface Web**
1. Connectez-vous à https://ngrok-detector.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ngrok-detector.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ngrok-detector.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
