...
### **Interface Web**
1. Connectez-vous à https://logicamp-ftp.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://logicamp-ftp.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://logicamp-ftp.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
