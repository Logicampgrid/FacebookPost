...
### **Interface Web**
1. Connectez-vous à https://data-enhancer.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://data-enhancer.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://data-enhancer.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
