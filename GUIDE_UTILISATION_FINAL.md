...
### **Interface Web**
1. Connectez-vous à https://blank-page-fix-9.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://blank-page-fix-9.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://blank-page-fix-9.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
