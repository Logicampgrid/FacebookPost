...
### **API Directe**
```bash
GET https://link-image-debug.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://link-image-debug.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
