...
### **Interface Web**
1. Connectez-vous à https://carry-on-174.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://carry-on-174.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://carry-on-174.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
