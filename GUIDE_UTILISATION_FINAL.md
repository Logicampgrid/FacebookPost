...
### **Interface Web**
1. Connectez-vous à https://connection-failed.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://connection-failed.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://connection-failed.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
