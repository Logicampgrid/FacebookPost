...
### **Interface Web**
1. Connectez-vous à https://ai-assistant-210.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ai-assistant-210.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ai-assistant-210.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
