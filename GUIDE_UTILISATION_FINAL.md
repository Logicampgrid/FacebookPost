...
### **Interface Web**
1. Connectez-vous à https://fb-autopub-config.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://fb-autopub-config.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://fb-autopub-config.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
