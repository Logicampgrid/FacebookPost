...
### **Interface Web**
1. Connectez-vous à https://private-webhook.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://private-webhook.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://private-webhook.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
