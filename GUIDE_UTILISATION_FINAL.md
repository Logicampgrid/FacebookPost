...
### **Interface Web**
1. Connectez-vous à https://insta-next.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://insta-next.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://insta-next.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://insta-next.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
