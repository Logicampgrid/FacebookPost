...
### **Interface Web**
1. Connectez-vous à https://ngrok-detect.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ngrok-detect.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ngrok-detect.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
