...
### **Interface Web**
1. Connectez-vous à https://format-guard.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://format-guard.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://format-guard.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
