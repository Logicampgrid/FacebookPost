...
### **Interface Web**
1. Connectez-vous à https://ftp-uploader.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ftp-uploader.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://ftp-uploader.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
