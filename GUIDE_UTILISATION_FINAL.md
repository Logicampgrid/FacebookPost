...
### **Interface Web**
1. Connectez-vous à https://video-post-feature.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://video-post-feature.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://video-post-feature.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
