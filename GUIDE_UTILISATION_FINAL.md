...
### **Interface Web**
1. Connectez-vous à https://fb-webhook-local.preview.emergentagent.com
...
```bash
curl -s "https://fb-webhook-local.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
