...
### **Interface Web**
1. Connectez-vous à https://ecu-corrector.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://ecu-corrector.preview.emergentagent.com/api/webhook-history?limit=100
```
...
### **Test Simple**
```bash
curl -X POST "https://ecu-corrector.preview.emergentagent.com/api/publishProduct/test" \
...
```bash
curl -s "https://ecu-corrector.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
