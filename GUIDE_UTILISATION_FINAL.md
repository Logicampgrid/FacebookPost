...
### **Interface Web**
1. Connectez-vous à https://tunnel-gram.preview.emergentagent.com
...
### **API Directe**
```bash
GET https://tunnel-gram.preview.emergentagent.com/api/webhook-history?limit=100
```
...
```bash
curl -s "https://tunnel-gram.preview.emergentagent.com/api/publishProduct/config" | jq '.shop_types'
```
