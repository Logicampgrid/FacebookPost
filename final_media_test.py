...
def test_url_construction():
    ...
    if media_url.startswith('http'):
        ...
        base_url = os.getenv("PUBLIC_BASE_URL", "https://img-facebook-fix.preview.emergentagent.com")
...
def main():
    ...
    print("- Default fallback to 'https://img-facebook-fix.preview.emergentagent.com'")
