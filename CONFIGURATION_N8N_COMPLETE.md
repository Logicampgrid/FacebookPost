...
```
**Solution :** Reconnectez-vous sur https://meta-publish-app.preview.emergentagent.com
...
```bash
curl -X POST "https://meta-publish-app.preview.emergentagent.com/api/publishProduct/test" \
