...
```
**Solution :** Reconnectez-vous sur https://format-guard.preview.emergentagent.com
...
```bash
curl -X POST "https://format-guard.preview.emergentagent.com/api/publishProduct/test" \
