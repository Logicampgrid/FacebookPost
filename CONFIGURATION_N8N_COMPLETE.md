...
```
**Solution :** Reconnectez-vous sur https://instagram-diag.preview.emergentagent.com
...
```bash
curl -X POST "https://instagram-diag.preview.emergentagent.com/api/publishProduct/test" \
