...
{
  "method": "POST",
  "url": "https://webhoek-next.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://webhoek-next.preview.emergentagent.com
...
```bash
curl -X POST "https://webhoek-next.preview.emergentagent.com/api/publishProduct/test" \
