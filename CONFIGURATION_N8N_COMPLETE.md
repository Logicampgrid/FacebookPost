...
```
**Solution :** Reconnectez-vous sur https://fb-link-poster.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-link-poster.preview.emergentagent.com/api/publishProduct/test" \
