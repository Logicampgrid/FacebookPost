...
{
  "method": "POST",
  "url": "https://ok-system-4.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ok-system-4.preview.emergentagent.com
...
```bash
curl -X POST "https://ok-system-4.preview.emergentagent.com/api/publishProduct/test" \
