...
```
**Solution :** Reconnectez-vous sur https://bugfix-login.preview.emergentagent.com
...
```bash
curl -X POST "https://bugfix-login.preview.emergentagent.com/api/publishProduct/test" \
