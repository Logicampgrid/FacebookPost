...
```
**Solution :** Reconnectez-vous sur https://social-media-sync-1.preview.emergentagent.com
...
```bash
curl -X POST "https://social-media-sync-1.preview.emergentagent.com/api/publishProduct/test" \
