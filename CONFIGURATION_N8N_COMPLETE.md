...
```
**Solution :** Reconnectez-vous sur https://prompt-emergent.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-emergent.preview.emergentagent.com/api/publishProduct/test" \
