...
```
**Solution :** Reconnectez-vous sur https://auth-relay-1.preview.emergentagent.com
...
```bash
curl -X POST "https://auth-relay-1.preview.emergentagent.com/api/publishProduct/test" \
