...
```
**Solution :** Reconnectez-vous sur https://facebook-auth-patch.preview.emergentagent.com
...
```bash
curl -X POST "https://facebook-auth-patch.preview.emergentagent.com/api/publishProduct/test" \
