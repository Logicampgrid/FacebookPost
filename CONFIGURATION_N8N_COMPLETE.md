...
{
  "method": "POST",
  "url": "https://ok-simple-19.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ok-simple-19.preview.emergentagent.com
...
```bash
curl -X POST "https://ok-simple-19.preview.emergentagent.com/api/publishProduct/test" \
