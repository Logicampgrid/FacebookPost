...
```
**Solution :** Reconnectez-vous sur https://instapost-update.preview.emergentagent.com
...
```bash
curl -X POST "https://instapost-update.preview.emergentagent.com/api/publishProduct/test" \
