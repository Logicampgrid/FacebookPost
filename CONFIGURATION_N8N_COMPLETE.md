...
```
**Solution :** Reconnectez-vous sur https://social-sync-tool.preview.emergentagent.com
...
```bash
curl -X POST "https://social-sync-tool.preview.emergentagent.com/api/publishProduct/test" \
