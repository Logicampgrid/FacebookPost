...
```
**Solution :** Reconnectez-vous sur https://meta-publisher.preview.emergentagent.com
...
```bash
curl -X POST "https://meta-publisher.preview.emergentagent.com/api/publishProduct/test" \
