...
```
**Solution :** Reconnectez-vous sur https://webpub-debug.preview.emergentagent.com
...
```bash
curl -X POST "https://webpub-debug.preview.emergentagent.com/api/publishProduct/test" \
