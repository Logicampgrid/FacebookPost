...
```
**Solution :** Reconnectez-vous sur https://emergentsh-boost.preview.emergentagent.com
...
```bash
curl -X POST "https://emergentsh-boost.preview.emergentagent.com/api/publishProduct/test" \
