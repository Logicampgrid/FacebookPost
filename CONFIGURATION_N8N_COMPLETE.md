...
```
**Solution :** Reconnectez-vous sur https://video-post-feature.preview.emergentagent.com
...
```bash
curl -X POST "https://video-post-feature.preview.emergentagent.com/api/publishProduct/test" \
