...
```
**Solution :** Reconnectez-vous sur https://tunnel-gram.preview.emergentagent.com
...
```bash
curl -X POST "https://tunnel-gram.preview.emergentagent.com/api/publishProduct/test" \
