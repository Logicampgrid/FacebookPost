...
```
**Solution :** Reconnectez-vous sur https://socialapi-sync.preview.emergentagent.com
...
```bash
curl -X POST "https://socialapi-sync.preview.emergentagent.com/api/publishProduct/test" \
