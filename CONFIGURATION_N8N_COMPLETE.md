...
```
**Solution :** Reconnectez-vous sur https://social-publish-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://social-publish-fix.preview.emergentagent.com/api/publishProduct/test" \
