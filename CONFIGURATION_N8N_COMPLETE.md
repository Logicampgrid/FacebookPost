...
```
**Solution :** Reconnectez-vous sur https://fb-oauth-tunnel.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-oauth-tunnel.preview.emergentagent.com/api/publishProduct/test" \
