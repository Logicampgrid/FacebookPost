...
```
**Solution :** Reconnectez-vous sur https://crosspost-oauth.preview.emergentagent.com
...
```bash
curl -X POST "https://crosspost-oauth.preview.emergentagent.com/api/publishProduct/test" \
