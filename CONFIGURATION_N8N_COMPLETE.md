...
```
**Solution :** Reconnectez-vous sur https://logicamp-ftp.preview.emergentagent.com
...
```bash
curl -X POST "https://logicamp-ftp.preview.emergentagent.com/api/publishProduct/test" \
