...
{
  "method": "POST",
  "url": "https://fb-product-post.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://fb-product-post.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-product-post.preview.emergentagent.com/api/publishProduct/test" \
