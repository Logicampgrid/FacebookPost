...
```
**Solution :** Reconnectez-vous sur https://promptbot-1.preview.emergentagent.com
...
```bash
curl -X POST "https://promptbot-1.preview.emergentagent.com/api/publishProduct/test" \
