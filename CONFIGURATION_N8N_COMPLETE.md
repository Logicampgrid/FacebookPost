...
{
  "method": "POST",
  "url": "https://image-ftp-insta.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://image-ftp-insta.preview.emergentagent.com
...
```bash
curl -X POST "https://image-ftp-insta.preview.emergentagent.com/api/publishProduct/test" \
