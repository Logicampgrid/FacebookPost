...
```
**Solution :** Reconnectez-vous sur https://code-mender-3.preview.emergentagent.com
...
```bash
curl -X POST "https://code-mender-3.preview.emergentagent.com/api/publishProduct/test" \
