...
```
**Solution :** Reconnectez-vous sur https://prompt-wizard-156.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-wizard-156.preview.emergentagent.com/api/publishProduct/test" \
