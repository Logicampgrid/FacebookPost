...
```
**Solution :** Reconnectez-vous sur https://emergent-n8n-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-n8n-fix.preview.emergentagent.com/api/publishProduct/test" \
