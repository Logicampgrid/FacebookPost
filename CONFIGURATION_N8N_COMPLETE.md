...
```
**Solution :** Reconnectez-vous sur https://dev-assistant-fb.preview.emergentagent.com
...
```bash
curl -X POST "https://dev-assistant-fb.preview.emergentagent.com/api/publishProduct/test" \
