...
```
**Solution :** Reconnectez-vous sur https://insta-upload.preview.emergentagent.com
...
```bash
curl -X POST "https://insta-upload.preview.emergentagent.com/api/publishProduct/test" \
