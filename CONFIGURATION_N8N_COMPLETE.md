...
```
**Solution :** Reconnectez-vous sur https://content-sync-app.preview.emergentagent.com
...
```bash
curl -X POST "https://content-sync-app.preview.emergentagent.com/api/publishProduct/test" \
