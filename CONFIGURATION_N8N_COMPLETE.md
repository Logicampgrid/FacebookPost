...
```
**Solution :** Reconnectez-vous sur https://codecraft-110.preview.emergentagent.com
...
```bash
curl -X POST "https://codecraft-110.preview.emergentagent.com/api/publishProduct/test" \
