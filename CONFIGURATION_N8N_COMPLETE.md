...
```
**Solution :** Reconnectez-vous sur https://social-autoposter-7.preview.emergentagent.com
...
```bash
curl -X POST "https://social-autoposter-7.preview.emergentagent.com/api/publishProduct/test" \
