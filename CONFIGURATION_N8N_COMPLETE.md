...
```
**Solution :** Reconnectez-vous sur https://upload-guard.preview.emergentagent.com
...
```bash
curl -X POST "https://upload-guard.preview.emergentagent.com/api/publishProduct/test" \
