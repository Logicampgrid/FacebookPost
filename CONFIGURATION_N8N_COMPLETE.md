...
```
**Solution :** Reconnectez-vous sur https://automedia-1.preview.emergentagent.com
...
```bash
curl -X POST "https://automedia-1.preview.emergentagent.com/api/publishProduct/test" \
