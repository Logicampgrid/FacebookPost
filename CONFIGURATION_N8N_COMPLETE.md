...
```
**Solution :** Reconnectez-vous sur https://emergent-helper-2.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-helper-2.preview.emergentagent.com/api/publishProduct/test" \
