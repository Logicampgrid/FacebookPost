...
```
**Solution :** Reconnectez-vous sur https://image-upload-fix-5.preview.emergentagent.com
...
```bash
curl -X POST "https://image-upload-fix-5.preview.emergentagent.com/api/publishProduct/test" \
