...
{
  "method": "POST",
  "url": "https://ok-demo-4.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ok-demo-4.preview.emergentagent.com
...
```bash
curl -X POST "https://ok-demo-4.preview.emergentagent.com/api/publishProduct/test" \
