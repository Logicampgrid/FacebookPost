...
```
**Solution :** Reconnectez-vous sur https://meta-publish-server.preview.emergentagent.com
...
```bash
curl -X POST "https://meta-publish-server.preview.emergentagent.com/api/publishProduct/test" \
