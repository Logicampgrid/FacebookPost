...
```
**Solution :** Reconnectez-vous sur https://promptgenius-13.preview.emergentagent.com
...
```bash
curl -X POST "https://promptgenius-13.preview.emergentagent.com/api/publishProduct/test" \
