...
```
**Solution :** Reconnectez-vous sur https://fb-insta-autopub.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-insta-autopub.preview.emergentagent.com/api/publishProduct/test" \
