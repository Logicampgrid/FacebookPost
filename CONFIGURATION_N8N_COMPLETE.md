...
```
**Solution :** Reconnectez-vous sur https://connection-failed.preview.emergentagent.com
...
```bash
curl -X POST "https://connection-failed.preview.emergentagent.com/api/publishProduct/test" \
