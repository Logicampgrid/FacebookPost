...
```
**Solution :** Reconnectez-vous sur https://insta-form-data.preview.emergentagent.com
...
```bash
curl -X POST "https://insta-form-data.preview.emergentagent.com/api/publishProduct/test" \
