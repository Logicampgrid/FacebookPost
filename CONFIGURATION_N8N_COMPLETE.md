...
```
**Solution :** Reconnectez-vous sur https://auto-post-ig.preview.emergentagent.com
...
```bash
curl -X POST "https://auto-post-ig.preview.emergentagent.com/api/publishProduct/test" \
