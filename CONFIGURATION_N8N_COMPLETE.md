...
```
**Solution :** Reconnectez-vous sur https://dev-ai-helper-1.preview.emergentagent.com
...
```bash
curl -X POST "https://dev-ai-helper-1.preview.emergentagent.com/api/publishProduct/test" \
