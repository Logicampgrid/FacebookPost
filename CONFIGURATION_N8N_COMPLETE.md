...
```
**Solution :** Reconnectez-vous sur https://facebook-poster.preview.emergentagent.com
...
```bash
curl -X POST "https://facebook-poster.preview.emergentagent.com/api/publishProduct/test" \
