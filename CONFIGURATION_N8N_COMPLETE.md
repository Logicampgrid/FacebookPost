...
{
  "method": "POST",
  "url": "https://progress-on-7.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://progress-on-7.preview.emergentagent.com
...
```bash
curl -X POST "https://progress-on-7.preview.emergentagent.com/api/publishProduct/test" \
