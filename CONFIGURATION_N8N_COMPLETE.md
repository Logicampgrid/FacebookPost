...
```
**Solution :** Reconnectez-vous sur https://autopost-4.preview.emergentagent.com
...
```bash
curl -X POST "https://autopost-4.preview.emergentagent.com/api/publishProduct/test" \
