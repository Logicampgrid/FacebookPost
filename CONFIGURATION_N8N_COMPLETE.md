...
```
**Solution :** Reconnectez-vous sur https://prompt-architect-14.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-architect-14.preview.emergentagent.com/api/publishProduct/test" \
