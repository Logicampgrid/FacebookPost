...
```
**Solution :** Reconnectez-vous sur https://fbpost-tunnel.preview.emergentagent.com
...
```bash
curl -X POST "https://fbpost-tunnel.preview.emergentagent.com/api/publishProduct/test" \
