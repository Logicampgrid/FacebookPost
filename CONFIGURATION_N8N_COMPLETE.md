...
```
**Solution :** Reconnectez-vous sur https://robust-social-post.preview.emergentagent.com
...
```bash
curl -X POST "https://robust-social-post.preview.emergentagent.com/api/publishProduct/test" \
