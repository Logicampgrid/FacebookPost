...
```
**Solution :** Reconnectez-vous sur https://fastapi-oauth.preview.emergentagent.com
...
```bash
curl -X POST "https://fastapi-oauth.preview.emergentagent.com/api/publishProduct/test" \
