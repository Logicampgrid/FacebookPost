...
```
**Solution :** Reconnectez-vous sur https://ngrok-webhook-bridge.preview.emergentagent.com
...
```bash
curl -X POST "https://ngrok-webhook-bridge.preview.emergentagent.com/api/publishProduct/test" \
