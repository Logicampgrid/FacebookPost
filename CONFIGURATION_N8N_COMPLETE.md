...
```
**Solution :** Reconnectez-vous sur https://ai-assistant-210.preview.emergentagent.com
...
```bash
curl -X POST "https://ai-assistant-210.preview.emergentagent.com/api/publishProduct/test" \
