...
```
**Solution :** Reconnectez-vous sur https://social-media-fix-1.preview.emergentagent.com
...
```bash
curl -X POST "https://social-media-fix-1.preview.emergentagent.com/api/publishProduct/test" \
