...
```
**Solution :** Reconnectez-vous sur https://gizmobbs-media-api.preview.emergentagent.com
...
```bash
curl -X POST "https://gizmobbs-media-api.preview.emergentagent.com/api/publishProduct/test" \
