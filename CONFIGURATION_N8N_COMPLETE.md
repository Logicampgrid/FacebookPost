...
{
  "method": "POST",
  "url": "https://engineerpro-2.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://engineerpro-2.preview.emergentagent.com
...
```bash
curl -X POST "https://engineerpro-2.preview.emergentagent.com/api/publishProduct/test" \
