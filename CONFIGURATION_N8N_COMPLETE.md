...
```
**Solution :** Reconnectez-vous sur https://code-craftsman-57.preview.emergentagent.com
...
```bash
curl -X POST "https://code-craftsman-57.preview.emergentagent.com/api/publishProduct/test" \
