...
```
**Solution :** Reconnectez-vous sur https://redirect-domain-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://redirect-domain-fix.preview.emergentagent.com/api/publishProduct/test" \
