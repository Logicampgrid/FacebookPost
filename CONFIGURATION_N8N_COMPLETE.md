...
```
**Solution :** Reconnectez-vous sur https://social-post-fix-2.preview.emergentagent.com
...
```bash
curl -X POST "https://social-post-fix-2.preview.emergentagent.com/api/publishProduct/test" \
