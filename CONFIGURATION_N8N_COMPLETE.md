...
```
**Solution :** Reconnectez-vous sur https://social-bridge-5.preview.emergentagent.com
...
```bash
curl -X POST "https://social-bridge-5.preview.emergentagent.com/api/publishProduct/test" \
