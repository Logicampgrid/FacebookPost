...
```
**Solution :** Reconnectez-vous sur https://auto-social-sync.preview.emergentagent.com
...
```bash
curl -X POST "https://auto-social-sync.preview.emergentagent.com/api/publishProduct/test" \
