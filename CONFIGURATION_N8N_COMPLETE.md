...
```
**Solution :** Reconnectez-vous sur https://auth-callback-fix-1.preview.emergentagent.com
...
```bash
curl -X POST "https://auth-callback-fix-1.preview.emergentagent.com/api/publishProduct/test" \
