...
{
  "method": "POST",
  "url": "https://keep-going-238.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://keep-going-238.preview.emergentagent.com
...
```bash
curl -X POST "https://keep-going-238.preview.emergentagent.com/api/publishProduct/test" \
