...
```
**Solution :** Reconnectez-vous sur https://berger-media-bug.preview.emergentagent.com
...
```bash
curl -X POST "https://berger-media-bug.preview.emergentagent.com/api/publishProduct/test" \
