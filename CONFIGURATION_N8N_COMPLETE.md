...
```
**Solution :** Reconnectez-vous sur https://fb-insta-bridge.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-insta-bridge.preview.emergentagent.com/api/publishProduct/test" \
