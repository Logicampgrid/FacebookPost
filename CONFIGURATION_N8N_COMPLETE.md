...
{
  "method": "POST",
  "url": "https://ngrok-detector.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ngrok-detector.preview.emergentagent.com
...
```bash
curl -X POST "https://ngrok-detector.preview.emergentagent.com/api/publishProduct/test" \
