...
```
**Solution :** Reconnectez-vous sur https://tunnel-finder.preview.emergentagent.com
...
```bash
curl -X POST "https://tunnel-finder.preview.emergentagent.com/api/publishProduct/test" \
