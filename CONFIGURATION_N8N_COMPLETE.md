...
```
**Solution :** Reconnectez-vous sur https://social-poster-7.preview.emergentagent.com
...
```bash
curl -X POST "https://social-poster-7.preview.emergentagent.com/api/publishProduct/test" \
