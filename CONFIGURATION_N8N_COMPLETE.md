...
{
  "method": "POST",
  "url": "https://meta-publisher-1.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://meta-publisher-1.preview.emergentagent.com
...
```bash
curl -X POST "https://meta-publisher-1.preview.emergentagent.com/api/publishProduct/test" \
