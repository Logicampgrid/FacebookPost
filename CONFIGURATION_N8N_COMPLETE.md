...
```
**Solution :** Reconnectez-vous sur https://local-oauth-proxy.preview.emergentagent.com
...
```bash
curl -X POST "https://local-oauth-proxy.preview.emergentagent.com/api/publishProduct/test" \
