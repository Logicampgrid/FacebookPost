...
```
**Solution :** Reconnectez-vous sur https://social-integrator.preview.emergentagent.com
...
```bash
curl -X POST "https://social-integrator.preview.emergentagent.com/api/publishProduct/test" \
