...
```
**Solution :** Reconnectez-vous sur https://token-exchange-5.preview.emergentagent.com
...
```bash
curl -X POST "https://token-exchange-5.preview.emergentagent.com/api/publishProduct/test" \
