...
```
**Solution :** Reconnectez-vous sur https://ftp-uploader.preview.emergentagent.com
...
```bash
curl -X POST "https://ftp-uploader.preview.emergentagent.com/api/publishProduct/test" \
