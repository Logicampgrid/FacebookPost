...
```
**Solution :** Reconnectez-vous sur https://media-uploader-6.preview.emergentagent.com
...
```bash
curl -X POST "https://media-uploader-6.preview.emergentagent.com/api/publishProduct/test" \
