...
```
**Solution :** Reconnectez-vous sur https://ai-prompt-tool-1.preview.emergentagent.com
...
```bash
curl -X POST "https://ai-prompt-tool-1.preview.emergentagent.com/api/publishProduct/test" \
