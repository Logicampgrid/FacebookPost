...
```
**Solution :** Reconnectez-vous sur https://fb-autopub-config.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-autopub-config.preview.emergentagent.com/api/publishProduct/test" \
