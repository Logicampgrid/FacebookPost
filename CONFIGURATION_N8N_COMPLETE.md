...
```
**Solution :** Reconnectez-vous sur https://flask-webhook-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://flask-webhook-fix.preview.emergentagent.com/api/publishProduct/test" \
