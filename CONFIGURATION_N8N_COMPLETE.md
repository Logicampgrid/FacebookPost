...
```
**Solution :** Reconnectez-vous sur https://dynamic-preview.preview.emergentagent.com
...
```bash
curl -X POST "https://dynamic-preview.preview.emergentagent.com/api/publishProduct/test" \
