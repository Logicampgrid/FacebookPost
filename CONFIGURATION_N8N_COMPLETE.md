...
```
**Solution :** Reconnectez-vous sur https://media-path-update.preview.emergentagent.com
...
```bash
curl -X POST "https://media-path-update.preview.emergentagent.com/api/publishProduct/test" \
