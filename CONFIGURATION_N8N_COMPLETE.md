...
```
**Solution :** Reconnectez-vous sur https://fb-connector-app.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-connector-app.preview.emergentagent.com/api/publishProduct/test" \
