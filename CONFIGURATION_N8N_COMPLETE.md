...
{
  "method": "POST",
  "url": "https://insta-post-fixer.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://insta-post-fixer.preview.emergentagent.com
...
```bash
curl -X POST "https://insta-post-fixer.preview.emergentagent.com/api/publishProduct/test" \
