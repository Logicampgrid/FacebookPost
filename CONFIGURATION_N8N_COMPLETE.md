...
```
**Solution :** Reconnectez-vous sur https://private-webhook.preview.emergentagent.com
...
```bash
curl -X POST "https://private-webhook.preview.emergentagent.com/api/publishProduct/test" \
