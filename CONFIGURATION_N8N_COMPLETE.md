...
```
**Solution :** Reconnectez-vous sur https://photo-path-converter.preview.emergentagent.com
...
```bash
curl -X POST "https://photo-path-converter.preview.emergentagent.com/api/publishProduct/test" \
