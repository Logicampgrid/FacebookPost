...
```
**Solution :** Reconnectez-vous sur https://fb-tunnel-backend.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-tunnel-backend.preview.emergentagent.com/api/publishProduct/test" \
