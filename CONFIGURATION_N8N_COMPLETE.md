...
```
**Solution :** Reconnectez-vous sur https://smart-fb-poster.preview.emergentagent.com
...
```bash
curl -X POST "https://smart-fb-poster.preview.emergentagent.com/api/publishProduct/test" \
