...
```
**Solution :** Reconnectez-vous sur https://social-login-app.preview.emergentagent.com
...
```bash
curl -X POST "https://social-login-app.preview.emergentagent.com/api/publishProduct/test" \
