...
```
**Solution :** Reconnectez-vous sur https://better-prompt.preview.emergentagent.com
...
```bash
curl -X POST "https://better-prompt.preview.emergentagent.com/api/publishProduct/test" \
