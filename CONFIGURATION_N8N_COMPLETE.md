...
```
**Solution :** Reconnectez-vous sur https://social-post-proxy.preview.emergentagent.com
...
```bash
curl -X POST "https://social-post-proxy.preview.emergentagent.com/api/publishProduct/test" \
