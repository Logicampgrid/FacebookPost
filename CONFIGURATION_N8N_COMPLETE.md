...
{
  "method": "POST",
  "url": "https://social-autopublish.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://social-autopublish.preview.emergentagent.com
...
```bash
curl -X POST "https://social-autopublish.preview.emergentagent.com/api/publishProduct/test" \
