...
```
**Solution :** Reconnectez-vous sur https://meta-vid-uploader.preview.emergentagent.com
...
```bash
curl -X POST "https://meta-vid-uploader.preview.emergentagent.com/api/publishProduct/test" \
