...
{
  "method": "POST",
  "url": "https://data-enhancer.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://data-enhancer.preview.emergentagent.com
...
```bash
curl -X POST "https://data-enhancer.preview.emergentagent.com/api/publishProduct/test" \
