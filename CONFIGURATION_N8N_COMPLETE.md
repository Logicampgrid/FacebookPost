...
```
**Solution :** Reconnectez-vous sur https://emergent-boost-1.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-boost-1.preview.emergentagent.com/api/publishProduct/test" \
