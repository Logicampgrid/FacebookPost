...
{
  "method": "POST",
  "url": "https://carry-on-174.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://carry-on-174.preview.emergentagent.com
...
```bash
curl -X POST "https://carry-on-174.preview.emergentagent.com/api/publishProduct/test" \
