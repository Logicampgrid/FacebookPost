...
```
**Solution :** Reconnectez-vous sur https://tunnel-detect.preview.emergentagent.com
...
```bash
curl -X POST "https://tunnel-detect.preview.emergentagent.com/api/publishProduct/test" \
