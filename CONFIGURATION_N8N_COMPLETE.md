...
```
**Solution :** Reconnectez-vous sur https://media-prep-1.preview.emergentagent.com
...
```bash
curl -X POST "https://media-prep-1.preview.emergentagent.com/api/publishProduct/test" \
