...
```
**Solution :** Reconnectez-vous sur https://social-commerce-hub-1.preview.emergentagent.com
...
```bash
curl -X POST "https://social-commerce-hub-1.preview.emergentagent.com/api/publishProduct/test" \
