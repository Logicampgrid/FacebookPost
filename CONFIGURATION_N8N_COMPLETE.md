...
```
**Solution :** Reconnectez-vous sur https://social-autopub.preview.emergentagent.com
...
```bash
curl -X POST "https://social-autopub.preview.emergentagent.com/api/publishProduct/test" \
