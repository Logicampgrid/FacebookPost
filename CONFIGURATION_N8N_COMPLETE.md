...
```
**Solution :** Reconnectez-vous sur https://social-media-sync.preview.emergentagent.com
...
```bash
curl -X POST "https://social-media-sync.preview.emergentagent.com/api/publishProduct/test" \
