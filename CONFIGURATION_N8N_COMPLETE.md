...
{
  "method": "POST",
  "url": "https://persistent-flow-1.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://persistent-flow-1.preview.emergentagent.com
...
```bash
curl -X POST "https://persistent-flow-1.preview.emergentagent.com/api/publishProduct/test" \
