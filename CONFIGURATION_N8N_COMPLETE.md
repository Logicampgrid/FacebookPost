...
```
**Solution :** Reconnectez-vous sur https://media-post.preview.emergentagent.com
...
```bash
curl -X POST "https://media-post.preview.emergentagent.com/api/publishProduct/test" \
