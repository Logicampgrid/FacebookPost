...
```
**Solution :** Reconnectez-vous sur https://auth-token-fix-5.preview.emergentagent.com
...
```bash
curl -X POST "https://auth-token-fix-5.preview.emergentagent.com/api/publishProduct/test" \
