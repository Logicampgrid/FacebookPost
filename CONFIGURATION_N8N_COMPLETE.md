...
{
  "method": "POST",
  "url": "https://insta-auto-fix.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://insta-auto-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://insta-auto-fix.preview.emergentagent.com/api/publishProduct/test" \
