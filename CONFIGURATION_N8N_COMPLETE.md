...
```
**Solution :** Reconnectez-vous sur https://emergent-prompt-1.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-prompt-1.preview.emergentagent.com/api/publishProduct/test" \
