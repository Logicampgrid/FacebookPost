...
```
**Solution :** Reconnectez-vous sur https://webhook-config.preview.emergentagent.com
...
```bash
curl -X POST "https://webhook-config.preview.emergentagent.com/api/publishProduct/test" \
