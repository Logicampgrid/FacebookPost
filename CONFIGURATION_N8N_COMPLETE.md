...
```
**Solution :** Reconnectez-vous sur https://auth-key-manager.preview.emergentagent.com
...
```bash
curl -X POST "https://auth-key-manager.preview.emergentagent.com/api/publishProduct/test" \
