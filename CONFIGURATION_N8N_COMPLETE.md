...
{
  "method": "POST",
  "url": "https://ok-acknowledge.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ok-acknowledge.preview.emergentagent.com
...
```bash
curl -X POST "https://ok-acknowledge.preview.emergentagent.com/api/publishProduct/test" \
