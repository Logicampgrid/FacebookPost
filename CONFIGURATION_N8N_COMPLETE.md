...
```
**Solution :** Reconnectez-vous sur https://fbpost-backfix.preview.emergentagent.com
...
```bash
curl -X POST "https://fbpost-backfix.preview.emergentagent.com/api/publishProduct/test" \
