...
{
  "method": "POST",
  "url": "https://file-webhook-api.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://file-webhook-api.preview.emergentagent.com
...
```bash
curl -X POST "https://file-webhook-api.preview.emergentagent.com/api/publishProduct/test" \
