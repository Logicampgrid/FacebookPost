...
```
**Solution :** Reconnectez-vous sur https://webhook-consolidate.preview.emergentagent.com
...
```bash
curl -X POST "https://webhook-consolidate.preview.emergentagent.com/api/publishProduct/test" \
