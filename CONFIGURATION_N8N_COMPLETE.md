...
```
**Solution :** Reconnectez-vous sur https://prompt-enhance-4.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-enhance-4.preview.emergentagent.com/api/publishProduct/test" \
