...
```
**Solution :** Reconnectez-vous sur https://login-gateway-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://login-gateway-fix.preview.emergentagent.com/api/publishProduct/test" \
