...
```
**Solution :** Reconnectez-vous sur https://code-compiler-check.preview.emergentagent.com
...
```bash
curl -X POST "https://code-compiler-check.preview.emergentagent.com/api/publishProduct/test" \
