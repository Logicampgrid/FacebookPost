...
```
**Solution :** Reconnectez-vous sur https://smart-emergent.preview.emergentagent.com
...
```bash
curl -X POST "https://smart-emergent.preview.emergentagent.com/api/publishProduct/test" \
