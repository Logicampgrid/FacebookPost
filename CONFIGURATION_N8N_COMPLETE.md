...
{
  "method": "POST",
  "url": "https://ok-minimal.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://ok-minimal.preview.emergentagent.com
...
```bash
curl -X POST "https://ok-minimal.preview.emergentagent.com/api/publishProduct/test" \
