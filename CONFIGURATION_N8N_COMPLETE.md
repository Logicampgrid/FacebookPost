...
```
**Solution :** Reconnectez-vous sur https://post-launcher-app.preview.emergentagent.com
...
```bash
curl -X POST "https://post-launcher-app.preview.emergentagent.com/api/publishProduct/test" \
