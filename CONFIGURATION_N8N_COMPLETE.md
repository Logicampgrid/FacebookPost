...
```
**Solution :** Reconnectez-vous sur https://social-post-logger.preview.emergentagent.com
...
```bash
curl -X POST "https://social-post-logger.preview.emergentagent.com/api/publishProduct/test" \
