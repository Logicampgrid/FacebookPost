...
```
**Solution :** Reconnectez-vous sur https://smart-prompt-5.preview.emergentagent.com
...
```bash
curl -X POST "https://smart-prompt-5.preview.emergentagent.com/api/publishProduct/test" \
