...
```
**Solution :** Reconnectez-vous sur https://prompt-engineer-13.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-engineer-13.preview.emergentagent.com/api/publishProduct/test" \
