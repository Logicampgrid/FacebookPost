...
{
  "method": "POST",
  "url": "https://img-facebook-fix.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://img-facebook-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://img-facebook-fix.preview.emergentagent.com/api/publishProduct/test" \
