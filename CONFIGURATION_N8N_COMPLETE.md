...
```
**Solution :** Reconnectez-vous sur https://dual-boutique.preview.emergentagent.com
...
```bash
curl -X POST "https://dual-boutique.preview.emergentagent.com/api/publishProduct/test" \
