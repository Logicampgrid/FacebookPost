...
```
**Solution :** Reconnectez-vous sur https://fb-media-manager.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-media-manager.preview.emergentagent.com/api/publishProduct/test" \
