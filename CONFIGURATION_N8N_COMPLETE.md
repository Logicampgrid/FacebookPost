...
```
**Solution :** Reconnectez-vous sur https://emergent-builder-9.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-builder-9.preview.emergentagent.com/api/publishProduct/test" \
