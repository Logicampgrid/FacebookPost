...
```
**Solution :** Reconnectez-vous sur https://facebookpost-app.preview.emergentagent.com
...
```bash
curl -X POST "https://facebookpost-app.preview.emergentagent.com/api/publishProduct/test" \
