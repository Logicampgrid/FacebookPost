...
```
**Solution :** Reconnectez-vous sur https://social-media-bridge.preview.emergentagent.com
...
```bash
curl -X POST "https://social-media-bridge.preview.emergentagent.com/api/publishProduct/test" \
