...
```
**Solution :** Reconnectez-vous sur https://offline-lifestyle.preview.emergentagent.com
...
```bash
curl -X POST "https://offline-lifestyle.preview.emergentagent.com/api/publishProduct/test" \
