...
{
  "method": "POST",
  "url": "https://berger-blanc-suisse.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://berger-blanc-suisse.preview.emergentagent.com
...
```bash
curl -X POST "https://berger-blanc-suisse.preview.emergentagent.com/api/publishProduct/test" \
