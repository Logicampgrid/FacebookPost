...
```
**Solution :** Reconnectez-vous sur https://smartprompt-7.preview.emergentagent.com
...
```bash
curl -X POST "https://smartprompt-7.preview.emergentagent.com/api/publishProduct/test" \
