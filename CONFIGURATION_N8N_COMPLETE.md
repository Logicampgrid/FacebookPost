...
```
**Solution :** Reconnectez-vous sur https://tunnel-update.preview.emergentagent.com
...
```bash
curl -X POST "https://tunnel-update.preview.emergentagent.com/api/publishProduct/test" \
