...
```
**Solution :** Reconnectez-vous sur https://fb-static-api.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-static-api.preview.emergentagent.com/api/publishProduct/test" \
