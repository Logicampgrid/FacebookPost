...
```
**Solution :** Reconnectez-vous sur https://prompt-workshop.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-workshop.preview.emergentagent.com/api/publishProduct/test" \
