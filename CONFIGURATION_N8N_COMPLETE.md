...
```
**Solution :** Reconnectez-vous sur https://emergent-upgrade.preview.emergentagent.com
...
```bash
curl -X POST "https://emergent-upgrade.preview.emergentagent.com/api/publishProduct/test" \
