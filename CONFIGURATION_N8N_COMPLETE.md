...
{
  "method": "POST",
  "url": "https://bbs-media-poster.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://bbs-media-poster.preview.emergentagent.com
...
```bash
curl -X POST "https://bbs-media-poster.preview.emergentagent.com/api/publishProduct/test" \
