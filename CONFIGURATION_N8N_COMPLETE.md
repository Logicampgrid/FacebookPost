...
```
**Solution :** Reconnectez-vous sur https://fb-post-backend.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-post-backend.preview.emergentagent.com/api/publishProduct/test" \
