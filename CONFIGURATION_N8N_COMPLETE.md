...
```
**Solution :** Reconnectez-vous sur https://frontend-access-1.preview.emergentagent.com
...
```bash
curl -X POST "https://frontend-access-1.preview.emergentagent.com/api/publishProduct/test" \
