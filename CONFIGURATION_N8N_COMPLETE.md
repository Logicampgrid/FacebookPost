...
```
**Solution :** Reconnectez-vous sur https://patch-master-8.preview.emergentagent.com
...
```bash
curl -X POST "https://patch-master-8.preview.emergentagent.com/api/publishProduct/test" \
