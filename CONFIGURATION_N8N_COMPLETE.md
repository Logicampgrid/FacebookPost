...
```
**Solution :** Reconnectez-vous sur https://media-converter-6.preview.emergentagent.com
...
```bash
curl -X POST "https://media-converter-6.preview.emergentagent.com/api/publishProduct/test" \
