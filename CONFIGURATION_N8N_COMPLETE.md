...
```
**Solution :** Reconnectez-vous sur https://emergentech-pro.preview.emergentagent.com
...
```bash
curl -X POST "https://emergentech-pro.preview.emergentagent.com/api/publishProduct/test" \
