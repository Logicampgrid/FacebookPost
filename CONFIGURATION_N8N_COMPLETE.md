...
{
  "method": "POST",
  "url": "https://insta-tunnel-free.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://insta-tunnel-free.preview.emergentagent.com
...
```bash
curl -X POST "https://insta-tunnel-free.preview.emergentagent.com/api/publishProduct/test" \
