...
```
**Solution :** Reconnectez-vous sur https://ngrokdetector.preview.emergentagent.com
...
```bash
curl -X POST "https://ngrokdetector.preview.emergentagent.com/api/publishProduct/test" \
