...
```
**Solution :** Reconnectez-vous sur https://facebookpost-app-1.preview.emergentagent.com
...
```bash
curl -X POST "https://facebookpost-app-1.preview.emergentagent.com/api/publishProduct/test" \
