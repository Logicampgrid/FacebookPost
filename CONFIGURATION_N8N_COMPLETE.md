...
{
  "method": "POST",
  "url": "https://basic-ok-2.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://basic-ok-2.preview.emergentagent.com
...
```bash
curl -X POST "https://basic-ok-2.preview.emergentagent.com/api/publishProduct/test" \
