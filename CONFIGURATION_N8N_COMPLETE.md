...
```
**Solution :** Reconnectez-vous sur https://fb-store-publisher.preview.emergentagent.com
...
```bash
curl -X POST "https://fb-store-publisher.preview.emergentagent.com/api/publishProduct/test" \
