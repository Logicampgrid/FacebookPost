...
```
**Solution :** Reconnectez-vous sur https://social-sync-5.preview.emergentagent.com
...
```bash
curl -X POST "https://social-sync-5.preview.emergentagent.com/api/publishProduct/test" \
