...
```
**Solution :** Reconnectez-vous sur https://prod-sync-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://prod-sync-fix.preview.emergentagent.com/api/publishProduct/test" \
