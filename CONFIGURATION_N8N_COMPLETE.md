...
```
**Solution :** Reconnectez-vous sur https://code-wizard-34.preview.emergentagent.com
...
```bash
curl -X POST "https://code-wizard-34.preview.emergentagent.com/api/publishProduct/test" \
