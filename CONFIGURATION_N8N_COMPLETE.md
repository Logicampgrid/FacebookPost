...
### **1. Production** 
```
POST https://just-ok-3.preview.emergentagent.com/api/publishProduct
```
→ **Publie réellement sur Facebook**

### **2. Test**
```
POST https://just-ok-3.preview.emergentagent.com/api/publishProduct/test  
```
→ **Simule la publication (pas de post Facebook créé)**

### **3. Configuration**
```
GET https://just-ok-3.preview.emergentagent.com/api/publishProduct/config
```
...
{
  "method": "POST",
  "url": "https://just-ok-3.preview.emergentagent.com/api/publishProduct",
  "authentication": "none",
  "requestFormat": "json"
}
```
...
```
**Solution :** Reconnectez-vous sur https://just-ok-3.preview.emergentagent.com
...
```bash
curl -X POST "https://just-ok-3.preview.emergentagent.com/api/publishProduct/test" \
