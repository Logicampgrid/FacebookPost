...
```
**Solution :** Reconnectez-vous sur https://fbpost-tunnel-1.preview.emergentagent.com
...
```bash
curl -X POST "https://fbpost-tunnel-1.preview.emergentagent.com/api/publishProduct/test" \
