...
```
**Solution :** Reconnectez-vous sur https://prompt-emergence.preview.emergentagent.com
...
```bash
curl -X POST "https://prompt-emergence.preview.emergentagent.com/api/publishProduct/test" \
