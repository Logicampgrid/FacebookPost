...
```
**Solution :** Reconnectez-vous sur https://social-domain-fix.preview.emergentagent.com
...
```bash
curl -X POST "https://social-domain-fix.preview.emergentagent.com/api/publishProduct/test" \
