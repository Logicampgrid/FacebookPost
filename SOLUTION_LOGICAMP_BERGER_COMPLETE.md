...
```
🌐 URL: https://emergent-prompt-1.preview.emergentagent.com
...
curl -X GET "https://emergent-prompt-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
