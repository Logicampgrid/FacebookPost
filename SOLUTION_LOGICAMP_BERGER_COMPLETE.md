...
```
🌐 URL: https://image-upload-fix-5.preview.emergentagent.com
...
curl -X GET "https://image-upload-fix-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
