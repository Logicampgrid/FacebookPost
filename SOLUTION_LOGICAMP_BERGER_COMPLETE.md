...
```
🌐 URL: https://blank-page-fix-9.preview.emergentagent.com
...
curl -X GET "https://blank-page-fix-9.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
