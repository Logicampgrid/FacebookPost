...
```
🌐 URL: https://fb-media-manager.preview.emergentagent.com
...
curl -X GET "https://fb-media-manager.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
