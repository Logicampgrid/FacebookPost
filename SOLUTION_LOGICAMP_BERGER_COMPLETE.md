...
```
🌐 URL: https://facebookpost-app.preview.emergentagent.com
...
curl -X GET "https://facebookpost-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
