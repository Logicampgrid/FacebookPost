...
```
🌐 URL: https://social-post-enhancer.preview.emergentagent.com
...
curl -X GET "https://social-post-enhancer.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
