...
```
🌐 URL: https://emergent-boost-1.preview.emergentagent.com
...
curl -X GET "https://emergent-boost-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
