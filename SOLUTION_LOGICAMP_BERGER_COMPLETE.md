...
```
🌐 URL: https://social-sync-tool.preview.emergentagent.com
...
curl -X GET "https://social-sync-tool.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
