...
```
🌐 URL: https://fb-store-publisher.preview.emergentagent.com
...
curl -X GET "https://fb-store-publisher.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
