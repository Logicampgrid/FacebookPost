...
```
🌐 URL: https://fb-insta-autopub.preview.emergentagent.com
...
curl -X GET "https://fb-insta-autopub.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
