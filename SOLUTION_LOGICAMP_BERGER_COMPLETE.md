...
```
🌐 URL: https://fb-graph-updater.preview.emergentagent.com
...
curl -X GET "https://fb-graph-updater.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
