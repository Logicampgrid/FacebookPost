...
```
🌐 URL: https://berger-media-bug.preview.emergentagent.com
...
curl -X GET "https://berger-media-bug.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
