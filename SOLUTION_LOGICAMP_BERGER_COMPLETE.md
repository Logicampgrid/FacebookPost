...
```
🌐 URL: https://fb-tunnel-backend.preview.emergentagent.com
...
curl -X GET "https://fb-tunnel-backend.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
