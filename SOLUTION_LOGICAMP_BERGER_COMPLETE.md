...
```
🌐 URL: https://post-launcher-app.preview.emergentagent.com
...
curl -X GET "https://post-launcher-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
