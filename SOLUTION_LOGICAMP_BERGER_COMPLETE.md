...
```
🌐 URL: https://prompt-wizard-139.preview.emergentagent.com
...
curl -X GET "https://prompt-wizard-139.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
