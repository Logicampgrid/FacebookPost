...
```
🌐 URL: https://social-post-proxy.preview.emergentagent.com
...
curl -X GET "https://social-post-proxy.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
