...
```
🌐 URL: https://facebookpost-app-1.preview.emergentagent.com
...
curl -X GET "https://facebookpost-app-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
