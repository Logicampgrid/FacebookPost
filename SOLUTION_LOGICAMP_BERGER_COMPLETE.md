...
```
🌐 URL: https://social-media-sync.preview.emergentagent.com
...
curl -X GET "https://social-media-sync.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
