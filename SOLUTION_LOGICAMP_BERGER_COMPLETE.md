...
```
🌐 URL: https://flask-webhook-fix.preview.emergentagent.com
...
curl -X GET "https://flask-webhook-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
