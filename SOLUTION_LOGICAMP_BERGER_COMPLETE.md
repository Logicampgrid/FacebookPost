...
```
🌐 URL: https://social-media-fix-1.preview.emergentagent.com
...
curl -X GET "https://social-media-fix-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
