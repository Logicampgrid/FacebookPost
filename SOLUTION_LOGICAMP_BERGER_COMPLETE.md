...
```
🌐 URL: https://media-converter-6.preview.emergentagent.com
...
curl -X GET "https://media-converter-6.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
