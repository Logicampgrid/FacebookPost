...
```
🌐 URL: https://social-integrator.preview.emergentagent.com
...
curl -X GET "https://social-integrator.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
