...
```
🌐 URL: https://emergentsh-boost.preview.emergentagent.com
...
curl -X GET "https://emergentsh-boost.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
