...
```
🌐 URL: https://ai-prompt-tool-1.preview.emergentagent.com
...
curl -X GET "https://ai-prompt-tool-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
