...
```
🌐 URL: https://social-media-sync-1.preview.emergentagent.com
...
curl -X GET "https://social-media-sync-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
