...
```
🌐 URL: https://ai-code-helper-4.preview.emergentagent.com
...
curl -X GET "https://ai-code-helper-4.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
