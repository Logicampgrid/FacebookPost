...
```
🌐 URL: https://local-oauth-proxy.preview.emergentagent.com
...
curl -X GET "https://local-oauth-proxy.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
