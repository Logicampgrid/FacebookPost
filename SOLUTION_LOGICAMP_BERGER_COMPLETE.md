...
```
🌐 URL: https://prompt-emergence.preview.emergentagent.com
...
curl -X GET "https://prompt-emergence.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
