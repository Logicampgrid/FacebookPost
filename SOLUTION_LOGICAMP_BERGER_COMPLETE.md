...
```
🌐 URL: https://media-path-update.preview.emergentagent.com
...
curl -X GET "https://media-path-update.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
