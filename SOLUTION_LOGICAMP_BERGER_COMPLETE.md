...
```
🌐 URL: https://social-media-fixer.preview.emergentagent.com
...
curl -X GET "https://social-media-fixer.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
