...
```
🌐 URL: https://prompt-architect-14.preview.emergentagent.com
...
curl -X GET "https://prompt-architect-14.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
