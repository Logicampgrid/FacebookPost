...
```
🌐 URL: https://media-display-fix-2.preview.emergentagent.com
...
curl -X GET "https://media-display-fix-2.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
