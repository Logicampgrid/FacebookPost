...
```
🌐 URL: https://offline-lifestyle.preview.emergentagent.com
...
curl -X GET "https://offline-lifestyle.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
