...
```
🌐 URL: https://auto-ngrok-updater.preview.emergentagent.com
...
curl -X GET "https://auto-ngrok-updater.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
