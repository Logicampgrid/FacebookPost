...
```
🌐 URL: https://redirect-domain-fix.preview.emergentagent.com
...
curl -X GET "https://redirect-domain-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
