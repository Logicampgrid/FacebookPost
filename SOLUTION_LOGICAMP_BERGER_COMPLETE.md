...
```
🌐 URL: https://emergent-upgrade.preview.emergentagent.com
...
curl -X GET "https://emergent-upgrade.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
