...
```
🌐 URL: https://connection-failed.preview.emergentagent.com
...
curl -X GET "https://connection-failed.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
