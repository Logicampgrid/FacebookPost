...
```
🌐 URL: https://meta-publish-app.preview.emergentagent.com
...
curl -X GET "https://meta-publish-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
