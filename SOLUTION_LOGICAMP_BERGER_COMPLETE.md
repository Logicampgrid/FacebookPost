...
```
🌐 URL: https://auth-callback-fix-1.preview.emergentagent.com
...
curl -X GET "https://auth-callback-fix-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
