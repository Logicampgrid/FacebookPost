...
```
🌐 URL: https://prompt-wizard-156.preview.emergentagent.com
...
curl -X GET "https://prompt-wizard-156.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
