...
```
🌐 URL: https://auth-key-manager.preview.emergentagent.com
...
curl -X GET "https://auth-key-manager.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
