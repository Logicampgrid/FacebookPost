...
```
🌐 URL: https://gizmobbs-media-api.preview.emergentagent.com
...
curl -X GET "https://gizmobbs-media-api.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
