...
```
🌐 URL: https://invalid-object-fix.preview.emergentagent.com
...
curl -X GET "https://invalid-object-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
