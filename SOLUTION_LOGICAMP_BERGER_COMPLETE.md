...
```
🌐 URL: https://meta-vid-uploader.preview.emergentagent.com
...
curl -X GET "https://meta-vid-uploader.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
