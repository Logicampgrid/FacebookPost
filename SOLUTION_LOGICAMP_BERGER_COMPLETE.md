...
```
🌐 URL: https://meta-post-manager.preview.emergentagent.com
...
curl -X GET "https://meta-post-manager.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
