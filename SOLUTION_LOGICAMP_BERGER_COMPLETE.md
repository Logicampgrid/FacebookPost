...
```
🌐 URL: https://emergent-helper-2.preview.emergentagent.com
...
curl -X GET "https://emergent-helper-2.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
