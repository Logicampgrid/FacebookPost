...
```
🌐 URL: https://video-post-feature.preview.emergentagent.com
...
curl -X GET "https://video-post-feature.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
