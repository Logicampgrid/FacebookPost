...
```
🌐 URL: https://prompt-enhance-4.preview.emergentagent.com
...
curl -X GET "https://prompt-enhance-4.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
