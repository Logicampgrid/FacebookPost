...
```
🌐 URL: https://prompt-engineer-14.preview.emergentagent.com
...
curl -X GET "https://prompt-engineer-14.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
