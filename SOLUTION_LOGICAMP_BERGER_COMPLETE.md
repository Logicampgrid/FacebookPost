...
```
🌐 URL: https://social-domain-fix.preview.emergentagent.com
...
curl -X GET "https://social-domain-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
