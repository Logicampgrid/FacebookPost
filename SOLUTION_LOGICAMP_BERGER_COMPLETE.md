...
```
🌐 URL: https://instapost-update.preview.emergentagent.com
...
curl -X GET "https://instapost-update.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
