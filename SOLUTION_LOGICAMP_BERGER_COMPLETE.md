...
```
🌐 URL: https://backend-alignment.preview.emergentagent.com
...
curl -X GET "https://backend-alignment.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
