...
```
🌐 URL: https://fb-connector-app.preview.emergentagent.com
...
curl -X GET "https://fb-connector-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
