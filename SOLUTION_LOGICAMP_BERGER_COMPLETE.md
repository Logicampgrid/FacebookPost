...
```
🌐 URL: https://product-share-hub.preview.emergentagent.com
...
curl -X GET "https://product-share-hub.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
