...
```
🌐 URL: https://code-assistant-33.preview.emergentagent.com
...
curl -X GET "https://code-assistant-33.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
