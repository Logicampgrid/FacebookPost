...
```bash
curl -X GET "https://meta-publisher-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
```
🌐 URL: https://meta-publisher-1.preview.emergentagent.com
...
```bash
# Status global
curl -X GET "https://meta-publisher-1.preview.emergentagent.com/api/health"

# Historique webhook gizmobbs
curl -X GET "https://meta-publisher-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
