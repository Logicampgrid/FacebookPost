...
```
🌐 URL: https://token-exchange-5.preview.emergentagent.com
...
curl -X GET "https://token-exchange-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
