...
```
🌐 URL: https://facebook-auth-fix-1.preview.emergentagent.com
...
curl -X GET "https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
