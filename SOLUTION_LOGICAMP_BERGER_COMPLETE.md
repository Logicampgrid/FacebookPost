...
```
🌐 URL: https://fb-insta-publisher.preview.emergentagent.com
...
curl -X GET "https://fb-insta-publisher.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
