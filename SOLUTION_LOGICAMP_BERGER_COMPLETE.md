...
```
🌐 URL: https://social-publisher-6.preview.emergentagent.com
...
curl -X GET "https://social-publisher-6.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
