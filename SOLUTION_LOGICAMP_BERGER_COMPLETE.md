...
```
🌐 URL: https://code-compiler-check.preview.emergentagent.com
...
curl -X GET "https://code-compiler-check.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
