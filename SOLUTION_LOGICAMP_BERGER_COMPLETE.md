...
```
🌐 URL: https://webhook-consolidate.preview.emergentagent.com
...
curl -X GET "https://webhook-consolidate.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
