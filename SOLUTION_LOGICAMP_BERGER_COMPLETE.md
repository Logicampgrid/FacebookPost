...
```
🌐 URL: https://dev-assistant-fb.preview.emergentagent.com
...
curl -X GET "https://dev-assistant-fb.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
