...
```
🌐 URL: https://emergent-builder-9.preview.emergentagent.com
...
curl -X GET "https://emergent-builder-9.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
