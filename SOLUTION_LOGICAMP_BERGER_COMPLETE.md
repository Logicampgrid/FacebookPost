...
```
🌐 URL: https://clickable-fb-posts.preview.emergentagent.com
...
curl -X GET "https://clickable-fb-posts.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
