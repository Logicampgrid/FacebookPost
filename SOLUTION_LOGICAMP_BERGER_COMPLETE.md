...
```
🌐 URL: https://social-media-bridge.preview.emergentagent.com
...
curl -X GET "https://social-media-bridge.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
