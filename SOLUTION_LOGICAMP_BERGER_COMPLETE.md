...
```
🌐 URL: https://ngrok-fb-publisher.preview.emergentagent.com
...
curl -X GET "https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
