...
```
🌐 URL: https://auth-token-fix-5.preview.emergentagent.com
...
curl -X GET "https://auth-token-fix-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
