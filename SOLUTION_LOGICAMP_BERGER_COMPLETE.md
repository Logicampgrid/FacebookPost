...
```
🌐 URL: https://auto-social-sync.preview.emergentagent.com
...
curl -X GET "https://auto-social-sync.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"
```
