        ...
        if clean_url:
            for strategy in download_strategies:
                try:
                    ...
                    # MODIFICATION POUR UPLOAD LOCAL - utilisation du répertoire persistant /gizmobbs/uploads
                    local_path = f"/gizmobbs/uploads/processed/media_{timestamp}_{unique_id}{extension}"
...
async def facebook_image_display_diagnostic():
    ...
    try:
        ...
        public_base_url = os.getenv("PUBLIC_BASE_URL", "https://media-path-update.preview.emergentagent.com")
...
def get_dynamic_base_url() -> str:
    ...
    base_url = os.getenv("PUBLIC_BASE_URL", "https://media-path-update.preview.emergentagent.com")
