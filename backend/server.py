...
async def facebook_image_display_diagnostic():
    ...
    try:
        ...
        public_base_url = os.getenv("PUBLIC_BASE_URL", "https://image-ftp-insta.preview.emergentagent.com")
...
def get_dynamic_base_url() -> str:
    ...
    base_url = os.getenv("PUBLIC_BASE_URL", "https://image-ftp-insta.preview.emergentagent.com")
...
def validate_and_prepare_image(file_url: str) -> str:
    ...
    Args:
        file_url: URL ou chemin local du fichier à valider et préparer
    
    Returns:
        str: Chemin local de l'image prête à l'upload si succès
        
    Raises:
        Exception: Si la validation ou préparation échoue
    """
    try:
