...
curl -X GET "https://facebook-auth-patch.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://facebook-auth-patch.preview.emergentagent.com/api/webhook"
