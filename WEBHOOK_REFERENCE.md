...
curl -X GET "https://prompt-architect-14.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://prompt-architect-14.preview.emergentagent.com/api/webhook"
