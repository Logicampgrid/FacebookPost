...
curl -X GET "https://dev-assistant-fb.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://dev-assistant-fb.preview.emergentagent.com/api/webhook"
