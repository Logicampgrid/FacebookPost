...
curl -X GET "https://auth-key-manager.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://auth-key-manager.preview.emergentagent.com/api/webhook"
