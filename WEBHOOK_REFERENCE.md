...
curl -X GET "https://photo-path-converter.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://photo-path-converter.preview.emergentagent.com/api/webhook"
