...
curl -X GET "https://token-exchange-5.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://token-exchange-5.preview.emergentagent.com/api/webhook"
