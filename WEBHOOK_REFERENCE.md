...
curl -X GET "https://code-craftsman-57.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://code-craftsman-57.preview.emergentagent.com/api/webhook"
