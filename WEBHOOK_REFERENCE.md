...
curl -X GET "https://smartprompt-7.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://smartprompt-7.preview.emergentagent.com/api/webhook"

# Info webhook enhanced  
curl -X GET "https://smartprompt-7.preview.emergentagent.com/api/webhook/enhanced"
```
...
- **URL** : `https://smartprompt-7.preview.emergentagent.com/api/webhook/enhanced`
- **Method** : `POST`
