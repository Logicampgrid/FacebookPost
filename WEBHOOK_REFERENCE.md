...
curl -X GET "https://code-mentor-pro.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://code-mentor-pro.preview.emergentagent.com/api/webhook"
