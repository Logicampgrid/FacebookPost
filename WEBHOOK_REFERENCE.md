...
curl -X GET "https://ai-code-helper-4.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://ai-code-helper-4.preview.emergentagent.com/api/webhook"
