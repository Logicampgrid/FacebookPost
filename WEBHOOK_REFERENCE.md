...
curl -X GET "https://flask-webhook-fix.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://flask-webhook-fix.preview.emergentagent.com/api/webhook"
