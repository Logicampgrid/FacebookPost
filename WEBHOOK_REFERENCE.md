...
curl -X GET "https://frontend-access.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://frontend-access.preview.emergentagent.com/api/webhook"
