...
curl -X GET "https://fb-autopub-config.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fb-autopub-config.preview.emergentagent.com/api/webhook"
