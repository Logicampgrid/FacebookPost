...
curl -X GET "https://smart-prompt-5.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://smart-prompt-5.preview.emergentagent.com/api/webhook"
