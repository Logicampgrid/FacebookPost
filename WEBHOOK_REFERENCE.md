...
curl -X GET "https://insta-form-data.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://insta-form-data.preview.emergentagent.com/api/webhook"
