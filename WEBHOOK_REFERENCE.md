...
curl -X GET "https://auth-callback-fix-1.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://auth-callback-fix-1.preview.emergentagent.com/api/webhook"
