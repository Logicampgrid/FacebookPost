...
curl -X GET "https://patch-master-8.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://patch-master-8.preview.emergentagent.com/api/webhook"
