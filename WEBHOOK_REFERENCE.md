...
curl -X GET "https://code-fixer-59.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://code-fixer-59.preview.emergentagent.com/api/webhook"
