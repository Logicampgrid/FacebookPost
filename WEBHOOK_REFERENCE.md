...
curl -X GET "https://prompt-workshop.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://prompt-workshop.preview.emergentagent.com/api/webhook"
