...
curl -X GET "https://facebookpost-app-1.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://facebookpost-app-1.preview.emergentagent.com/api/webhook"
