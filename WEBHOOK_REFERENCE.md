...
curl -X GET "https://insta-upload.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://insta-upload.preview.emergentagent.com/api/webhook"
