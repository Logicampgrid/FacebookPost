...
curl -X GET "https://fb-graph-updater.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fb-graph-updater.preview.emergentagent.com/api/webhook"
