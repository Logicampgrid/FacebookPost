...
curl -X GET "https://tunnel-detect.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://tunnel-detect.preview.emergentagent.com/api/webhook"
