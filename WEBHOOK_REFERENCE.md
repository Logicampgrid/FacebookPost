...
curl -X GET "https://content-sync-app.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://content-sync-app.preview.emergentagent.com/api/webhook"
