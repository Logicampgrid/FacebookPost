...
curl -X GET "https://auth-token-fix-5.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://auth-token-fix-5.preview.emergentagent.com/api/webhook"
