...
curl -X GET "https://code-mender-3.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://code-mender-3.preview.emergentagent.com/api/webhook"
