...
curl -X GET "https://emergent-upgrade.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://emergent-upgrade.preview.emergentagent.com/api/webhook"
