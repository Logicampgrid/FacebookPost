...
curl -X GET "https://ngrok-detector.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://ngrok-detector.preview.emergentagent.com/api/webhook"
