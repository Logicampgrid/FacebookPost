...
curl -X GET "https://dev-ai-helper-1.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://dev-ai-helper-1.preview.emergentagent.com/api/webhook"
