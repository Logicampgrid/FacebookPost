...
curl -X GET "https://redirect-domain-fix.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://redirect-domain-fix.preview.emergentagent.com/api/webhook"
