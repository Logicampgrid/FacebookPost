...
curl -X GET "https://local-oauth-proxy.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://local-oauth-proxy.preview.emergentagent.com/api/webhook"
