...
curl -X GET "https://smart-emergent.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://smart-emergent.preview.emergentagent.com/api/webhook"
