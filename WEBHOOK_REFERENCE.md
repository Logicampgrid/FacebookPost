...
curl -X GET "https://private-webhook.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://private-webhook.preview.emergentagent.com/api/webhook"
