...
curl -X GET "https://engineerpro-2.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://engineerpro-2.preview.emergentagent.com/api/webhook"
