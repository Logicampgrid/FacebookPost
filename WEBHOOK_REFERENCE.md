...
curl -X GET "https://fb-media-manager.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fb-media-manager.preview.emergentagent.com/api/webhook"
