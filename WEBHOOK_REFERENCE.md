...
curl -X GET "https://fb-connector-app.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fb-connector-app.preview.emergentagent.com/api/webhook"
