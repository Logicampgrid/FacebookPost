...
curl -X GET "https://auth-system-13.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://auth-system-13.preview.emergentagent.com/api/webhook"
