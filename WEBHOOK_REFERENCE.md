...
curl -X GET "https://connection-failed.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://connection-failed.preview.emergentagent.com/api/webhook"
