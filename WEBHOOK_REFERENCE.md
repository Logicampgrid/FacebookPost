...
curl -X GET "https://upload-guard.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://upload-guard.preview.emergentagent.com/api/webhook"
