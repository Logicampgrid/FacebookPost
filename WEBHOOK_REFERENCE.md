...
curl -X GET "https://fb-webhook-local.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fb-webhook-local.preview.emergentagent.com/api/webhook"
