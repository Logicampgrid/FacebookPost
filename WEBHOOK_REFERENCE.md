...
curl -X GET "https://fbpost-tunnel-1.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://fbpost-tunnel-1.preview.emergentagent.com/api/webhook"
