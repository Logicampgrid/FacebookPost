...
curl -X GET "https://code-wizard-38.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://code-wizard-38.preview.emergentagent.com/api/webhook"
