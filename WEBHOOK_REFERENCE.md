...
curl -X GET "https://webpub-debug.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://webpub-debug.preview.emergentagent.com/api/webhook"
