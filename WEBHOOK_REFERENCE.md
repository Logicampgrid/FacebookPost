...
curl -X GET "https://emergent-n8n-fix.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://emergent-n8n-fix.preview.emergentagent.com/api/webhook"
