...
curl -X GET "https://social-sync-5.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://social-sync-5.preview.emergentagent.com/api/webhook"
