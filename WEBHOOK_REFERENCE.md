...
curl -X GET "https://better-prompt.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://better-prompt.preview.emergentagent.com/api/webhook"
