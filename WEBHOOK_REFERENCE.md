...
curl -X GET "https://socialapi-sync.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://socialapi-sync.preview.emergentagent.com/api/webhook"
