...
curl -X GET "https://ngrok-webhook-bridge.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://ngrok-webhook-bridge.preview.emergentagent.com/api/webhook"
