...
curl -X GET "https://media-path-update.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://media-path-update.preview.emergentagent.com/api/webhook"
