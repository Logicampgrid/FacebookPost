...
curl -X GET "https://media-upload-fix-3.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://media-upload-fix-3.preview.emergentagent.com/api/webhook"
