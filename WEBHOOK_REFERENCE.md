...
curl -X GET "https://prompt-emergent.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://prompt-emergent.preview.emergentagent.com/api/webhook"
