...
curl -X GET "https://meta-publish-app.preview.emergentagent.com/api/debug/facebook-image-fix"

# Info webhook standard
curl -X GET "https://meta-publish-app.preview.emergentagent.com/api/webhook"
