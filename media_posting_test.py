...
class MediaPostingTester:
    ...
    def test_media_url_access(self):
        ...
        problematic_url = "https://webhook-config.preview.emergentagent.com/uploads/d2928827-e813-46fd-bb1c-246278aab168.jpg"
        ...
        uploads_dir_url = "https://webhook-config.preview.emergentagent.com/uploads/"
        try:
