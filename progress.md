...
- ✅ **Solution**: Utiliser l'URL Emergent `https://ai-code-helper-4.preview.emergentagent.com`
...
```
N8N → https://ai-code-helper-4.preview.emergentagent.com/api/webhook
...
`https://ai-code-helper-4.preview.emergentagent.com` est l'URL publique stable 
...
**Problème identifié** :
- ❌ **URL incorrecte** : `https://ai-code-helper-4.preview.emergentagent.com` utilisée pour les images
...
- ✅ **Conversion automatique** : `uploads\test_patch17.jpg` → `https://ai-code-helper-4.preview.emergentagent.com/uploads/test_patch17.jpg`
...
**Test de validation réussi** :
- ✅ Conversion automatique : `uploads\test_patch13.jpg` → `https://ai-code-helper-4.preview.emergentagent.com/uploads/test_patch13.jpg`
