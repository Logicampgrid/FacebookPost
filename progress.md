...
- ✅ **Solution**: Utiliser l'URL Emergent `https://emergent-boost-1.preview.emergentagent.com`
...
```
N8N → https://emergent-boost-1.preview.emergentagent.com/api/webhook
...
`https://emergent-boost-1.preview.emergentagent.com` est l'URL publique stable 
...
**Problème identifié** :
- ❌ **URL incorrecte** : `https://emergent-boost-1.preview.emergentagent.com` utilisée pour les images
...
- ✅ **Conversion automatique** : `uploads\test_patch17.jpg` → `https://emergent-boost-1.preview.emergentagent.com/uploads/test_patch17.jpg`
...
**Test de validation réussi** :
- ✅ Conversion automatique : `uploads\test_patch13.jpg` → `https://emergent-boost-1.preview.emergentagent.com/uploads/test_patch13.jpg`
