...
- ✅ **Solution**: Utiliser l'URL Emergent `https://code-mentor-pro.preview.emergentagent.com`
...
```
N8N → https://code-mentor-pro.preview.emergentagent.com/api/webhook
...
`https://code-mentor-pro.preview.emergentagent.com` est l'URL publique stable 
...
**Problème identifié** :
- ❌ **URL incorrecte** : `https://code-mentor-pro.preview.emergentagent.com` utilisée pour les images
...
- ✅ **Conversion automatique** : `uploads\test_patch17.jpg` → `https://code-mentor-pro.preview.emergentagent.com/uploads/test_patch17.jpg`
...
**Test de validation réussi** :
- ✅ Conversion automatique : `uploads\test_patch13.jpg` → `https://code-mentor-pro.preview.emergentagent.com/uploads/test_patch13.jpg`
