...
# Configuration
API_BASE = "https://code-compiler-check.preview.emergentagent.com"
...
def test_manual_post_with_clickable_image():
    ...
    print("=" * 60)
    print("1. Connectez-vous à l'application: https://code-compiler-check.preview.emergentagent.com")
