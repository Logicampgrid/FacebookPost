...
# Configuration
API_BASE = "https://photo-path-converter.preview.emergentagent.com"
...
def test_manual_post_with_clickable_image():
    ...
    print("=" * 60)
    print("1. Connectez-vous à l'application: https://photo-path-converter.preview.emergentagent.com")
