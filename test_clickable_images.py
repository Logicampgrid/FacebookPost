...
# Configuration
API_BASE = "https://redirect-domain-fix.preview.emergentagent.com"
...
def test_manual_post_with_clickable_image():
    ...
    print("=" * 60)
    print("1. Connectez-vous à l'application: https://redirect-domain-fix.preview.emergentagent.com")
