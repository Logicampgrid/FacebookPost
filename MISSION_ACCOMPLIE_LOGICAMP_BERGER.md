...
```bash
# Santé générale
curl "https://directoryflow.preview.emergentagent.com/api/health"
...
curl "https://directoryflow.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://directoryflow.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://directoryflow.preview.emergentagent.com
