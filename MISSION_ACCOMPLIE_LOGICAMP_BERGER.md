...
```bash
# Santé générale
curl "https://backend-alignment.preview.emergentagent.com/api/health"
...
curl "https://backend-alignment.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://backend-alignment.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://backend-alignment.preview.emergentagent.com
