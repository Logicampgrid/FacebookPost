...
```bash
# Santé générale
curl "https://socialapi-sync.preview.emergentagent.com/api/health"
...
curl "https://socialapi-sync.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://socialapi-sync.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://socialapi-sync.preview.emergentagent.com
