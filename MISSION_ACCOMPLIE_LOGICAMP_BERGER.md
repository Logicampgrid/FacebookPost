...
```bash
# Santé générale
curl "https://emergent-n8n-fix.preview.emergentagent.com/api/health"
...
curl "https://emergent-n8n-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://emergent-n8n-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://emergent-n8n-fix.preview.emergentagent.com
