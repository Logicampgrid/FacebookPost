...
```bash
# Santé générale
curl "https://emergentsh-boost.preview.emergentagent.com/api/health"
...
curl "https://emergentsh-boost.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://emergentsh-boost.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://emergentsh-boost.preview.emergentagent.com
