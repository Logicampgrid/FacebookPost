...
```bash
# Santé générale
curl "https://autopost-4.preview.emergentagent.com/api/health"
...
curl "https://autopost-4.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://autopost-4.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://autopost-4.preview.emergentagent.com
