...
```bash
# Santé générale
curl "https://prompt-emergence.preview.emergentagent.com/api/health"
...
curl "https://prompt-emergence.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://prompt-emergence.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://prompt-emergence.preview.emergentagent.com
