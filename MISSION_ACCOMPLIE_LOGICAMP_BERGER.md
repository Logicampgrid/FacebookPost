...
```bash
# Santé générale
curl "https://smart-emergent.preview.emergentagent.com/api/health"
...
curl "https://smart-emergent.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://smart-emergent.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://smart-emergent.preview.emergentagent.com
