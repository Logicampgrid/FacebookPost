...
```bash
# Santé générale
curl "https://login-gateway-fix.preview.emergentagent.com/api/health"
...
curl "https://login-gateway-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://login-gateway-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://login-gateway-fix.preview.emergentagent.com
