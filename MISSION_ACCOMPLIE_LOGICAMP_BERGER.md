...
```bash
# Santé générale
curl "https://dev-assistant-fb.preview.emergentagent.com/api/health"
...
curl "https://dev-assistant-fb.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://dev-assistant-fb.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://dev-assistant-fb.preview.emergentagent.com
