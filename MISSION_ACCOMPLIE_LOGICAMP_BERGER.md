...
```bash
# Santé générale
curl "https://ecu-corrector.preview.emergentagent.com/api/health"
...
curl "https://ecu-corrector.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://ecu-corrector.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://ecu-corrector.preview.emergentagent.com
