...
```bash
# Santé générale
curl "https://promptgenius-13.preview.emergentagent.com/api/health"
...
curl "https://promptgenius-13.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://promptgenius-13.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://promptgenius-13.preview.emergentagent.com
