...
1. **🌐 Ouvrez l'interface :**
   ```
   https://insta-tunnel-free.preview.emergentagent.com
   ```
...
```bash
# Santé générale
curl "https://insta-tunnel-free.preview.emergentagent.com/api/health"
...
curl "https://insta-tunnel-free.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://insta-tunnel-free.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://insta-tunnel-free.preview.emergentagent.com
