...
```bash
# Santé générale
curl "https://ai-code-helper-4.preview.emergentagent.com/api/health"
...
curl "https://ai-code-helper-4.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://ai-code-helper-4.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://ai-code-helper-4.preview.emergentagent.com
