...
```bash
# Santé générale
curl "https://connection-failed.preview.emergentagent.com/api/health"
...
curl "https://connection-failed.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://connection-failed.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://connection-failed.preview.emergentagent.com
