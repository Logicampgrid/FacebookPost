...
```bash
# Santé générale
curl "https://webpub-debug.preview.emergentagent.com/api/health"
...
curl "https://webpub-debug.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://webpub-debug.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://webpub-debug.preview.emergentagent.com
