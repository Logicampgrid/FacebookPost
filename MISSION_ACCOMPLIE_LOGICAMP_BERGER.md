...
```bash
# Santé générale
curl "https://prompt-emergent.preview.emergentagent.com/api/health"
...
curl "https://prompt-emergent.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://prompt-emergent.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://prompt-emergent.preview.emergentagent.com
