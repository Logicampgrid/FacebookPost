...
```bash
# Santé générale
curl "https://fastapi-oauth.preview.emergentagent.com/api/health"
...
curl "https://fastapi-oauth.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://fastapi-oauth.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://fastapi-oauth.preview.emergentagent.com
