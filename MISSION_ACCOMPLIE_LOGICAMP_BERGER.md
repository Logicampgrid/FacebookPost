...
```bash
# Santé générale
curl "https://product-share-hub.preview.emergentagent.com/api/health"
...
curl "https://product-share-hub.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://product-share-hub.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://product-share-hub.preview.emergentagent.com
