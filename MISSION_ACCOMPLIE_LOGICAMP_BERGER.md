...
```bash
# Santé générale
curl "https://blank-page-fix-9.preview.emergentagent.com/api/health"
...
curl "https://blank-page-fix-9.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://blank-page-fix-9.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://blank-page-fix-9.preview.emergentagent.com
