...
```bash
# Santé générale
curl "https://json-repair.preview.emergentagent.com/api/health"
...
curl "https://json-repair.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://json-repair.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://json-repair.preview.emergentagent.com
