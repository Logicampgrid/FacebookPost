...
```bash
# Santé générale
curl "https://fb-store-publisher.preview.emergentagent.com/api/health"
...
curl "https://fb-store-publisher.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://fb-store-publisher.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://fb-store-publisher.preview.emergentagent.com
