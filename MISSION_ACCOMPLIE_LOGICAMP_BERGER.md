...
1. **🌐 Ouvrez l'interface :**
   ```
   https://meta-publisher-1.preview.emergentagent.com
   ```
...
#### **Format JSON :**
```bash
curl -X POST "https://meta-publisher-1.preview.emergentagent.com/api/publishProduct" \
...
```bash
curl -X POST "https://meta-publisher-1.preview.emergentagent.com/api/webhook" \
...
```bash
# Santé générale
curl "https://meta-publisher-1.preview.emergentagent.com/api/health"

# Test spécifique @logicamp_berger
curl -X POST "https://meta-publisher-1.preview.emergentagent.com/api/debug/test-logicamp-berger-webhook"

# Historique publications gizmobbs
curl "https://meta-publisher-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://meta-publisher-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://meta-publisher-1.preview.emergentagent.com
