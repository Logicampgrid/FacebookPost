...
```bash
# Santé générale
curl "https://instagram-diag.preview.emergentagent.com/api/health"
...
curl "https://instagram-diag.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://instagram-diag.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://instagram-diag.preview.emergentagent.com
