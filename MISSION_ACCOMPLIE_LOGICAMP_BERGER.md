...
```bash
# Santé générale
curl "https://ngrokdetector.preview.emergentagent.com/api/health"
...
curl "https://ngrokdetector.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://ngrokdetector.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://ngrokdetector.preview.emergentagent.com
