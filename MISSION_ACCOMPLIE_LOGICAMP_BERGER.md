...
```bash
# Santé générale
curl "https://berger-media-bug.preview.emergentagent.com/api/health"
...
curl "https://berger-media-bug.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://berger-media-bug.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://berger-media-bug.preview.emergentagent.com
