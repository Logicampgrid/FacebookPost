...
```bash
# Santé générale
curl "https://meta-post-manager.preview.emergentagent.com/api/health"
...
curl "https://meta-post-manager.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://meta-post-manager.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://meta-post-manager.preview.emergentagent.com
