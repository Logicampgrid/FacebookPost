...
```bash
# Santé générale
curl "https://local-oauth-proxy.preview.emergentagent.com/api/health"
...
curl "https://local-oauth-proxy.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://local-oauth-proxy.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://local-oauth-proxy.preview.emergentagent.com
