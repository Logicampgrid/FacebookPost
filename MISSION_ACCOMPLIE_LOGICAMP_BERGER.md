...
```bash
# Santé générale
curl "https://code-fixer-59.preview.emergentagent.com/api/health"
...
curl "https://code-fixer-59.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://code-fixer-59.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://code-fixer-59.preview.emergentagent.com
