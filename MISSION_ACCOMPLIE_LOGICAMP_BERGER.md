...
```bash
# Santé générale
curl "https://invalid-object-fix.preview.emergentagent.com/api/health"
...
curl "https://invalid-object-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://invalid-object-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://invalid-object-fix.preview.emergentagent.com
