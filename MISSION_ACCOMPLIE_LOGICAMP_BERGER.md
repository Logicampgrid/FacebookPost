...
```bash
# Santé générale
curl "https://emergentech-pro.preview.emergentagent.com/api/health"
...
curl "https://emergentech-pro.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://emergentech-pro.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://emergentech-pro.preview.emergentagent.com
