...
```bash
# Santé générale
curl "https://secure-media-proxy.preview.emergentagent.com/api/health"
...
curl "https://secure-media-proxy.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://secure-media-proxy.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://secure-media-proxy.preview.emergentagent.com
