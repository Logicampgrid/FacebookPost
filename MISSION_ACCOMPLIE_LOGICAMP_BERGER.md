...
```bash
# Santé générale
curl "https://photo-path-converter.preview.emergentagent.com/api/health"
...
curl "https://photo-path-converter.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://photo-path-converter.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://photo-path-converter.preview.emergentagent.com
