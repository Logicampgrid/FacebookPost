...
```bash
# Santé générale
curl "https://redirect-domain-fix.preview.emergentagent.com/api/health"
...
curl "https://redirect-domain-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://redirect-domain-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://redirect-domain-fix.preview.emergentagent.com
