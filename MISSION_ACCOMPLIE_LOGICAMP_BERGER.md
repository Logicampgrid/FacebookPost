...
```bash
# Santé générale
curl "https://dynamic-preview.preview.emergentagent.com/api/health"
...
curl "https://dynamic-preview.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://dynamic-preview.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://dynamic-preview.preview.emergentagent.com
