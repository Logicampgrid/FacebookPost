...
```bash
# Santé générale
curl "https://crosspost-oauth.preview.emergentagent.com/api/health"
...
curl "https://crosspost-oauth.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://crosspost-oauth.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://crosspost-oauth.preview.emergentagent.com
