...
```bash
# Santé générale
curl "https://robust-social-post.preview.emergentagent.com/api/health"
...
curl "https://robust-social-post.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://robust-social-post.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://robust-social-post.preview.emergentagent.com
