...
```bash
# Santé générale
curl "https://smartprompt-7.preview.emergentagent.com/api/health"
...
curl "https://smartprompt-7.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://smartprompt-7.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://smartprompt-7.preview.emergentagent.com
