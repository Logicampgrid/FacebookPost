...
```bash
# Santé générale
curl "https://meta-publisher.preview.emergentagent.com/api/health"
...
curl "https://meta-publisher.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://meta-publisher.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://meta-publisher.preview.emergentagent.com
