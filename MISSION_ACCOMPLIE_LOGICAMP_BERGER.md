...
```bash
# Santé générale
curl "https://media-path-update.preview.emergentagent.com/api/health"
...
curl "https://media-path-update.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://media-path-update.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://media-path-update.preview.emergentagent.com
