...
```bash
# Santé générale
curl "https://social-integrator.preview.emergentagent.com/api/health"
...
curl "https://social-integrator.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://social-integrator.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://social-integrator.preview.emergentagent.com
