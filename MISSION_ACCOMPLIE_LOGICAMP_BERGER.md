...
```bash
# Santé générale
curl "https://meta-publish-app.preview.emergentagent.com/api/health"
...
curl "https://meta-publish-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://meta-publish-app.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://meta-publish-app.preview.emergentagent.com
