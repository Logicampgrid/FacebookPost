...
```bash
# Santé générale
curl "https://auto-ngrok-updater.preview.emergentagent.com/api/health"
...
curl "https://auto-ngrok-updater.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://auto-ngrok-updater.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://auto-ngrok-updater.preview.emergentagent.com
