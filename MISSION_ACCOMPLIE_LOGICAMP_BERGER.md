...
```bash
# Santé générale
curl "https://emergent-builder-9.preview.emergentagent.com/api/health"
...
curl "https://emergent-builder-9.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://emergent-builder-9.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://emergent-builder-9.preview.emergentagent.com
