...
```bash
# Santé générale
curl "https://logicamp-ftp.preview.emergentagent.com/api/health"
...
curl "https://logicamp-ftp.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://logicamp-ftp.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://logicamp-ftp.preview.emergentagent.com
