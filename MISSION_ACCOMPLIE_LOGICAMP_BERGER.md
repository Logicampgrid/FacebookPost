...
```bash
# Santé générale
curl "https://product-image-link-1.preview.emergentagent.com/api/health"
...
curl "https://product-image-link-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://product-image-link-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://product-image-link-1.preview.emergentagent.com
