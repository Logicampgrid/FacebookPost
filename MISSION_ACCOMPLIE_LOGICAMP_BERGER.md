...
```bash
# Santé générale
curl "https://gizmobbs-media-api.preview.emergentagent.com/api/health"
...
curl "https://gizmobbs-media-api.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://gizmobbs-media-api.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://gizmobbs-media-api.preview.emergentagent.com
