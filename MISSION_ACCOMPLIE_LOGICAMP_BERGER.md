...
```bash
# Santé générale
curl "https://auth-key-manager.preview.emergentagent.com/api/health"
...
curl "https://auth-key-manager.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://auth-key-manager.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://auth-key-manager.preview.emergentagent.com
