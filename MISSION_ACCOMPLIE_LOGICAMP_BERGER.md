...
```bash
# Santé générale
curl "https://smart-prompt-5.preview.emergentagent.com/api/health"
...
curl "https://smart-prompt-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://smart-prompt-5.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://smart-prompt-5.preview.emergentagent.com
