...
```bash
# Santé générale
curl "https://blank-ngrok.preview.emergentagent.com/api/health"
...
curl "https://blank-ngrok.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://blank-ngrok.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://blank-ngrok.preview.emergentagent.com
