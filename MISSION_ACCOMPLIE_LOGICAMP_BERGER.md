...
```bash
# Santé générale
curl "https://flask-webhook-fix.preview.emergentagent.com/api/health"
...
curl "https://flask-webhook-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://flask-webhook-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://flask-webhook-fix.preview.emergentagent.com
