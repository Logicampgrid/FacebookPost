...
```bash
# Santé générale
curl "https://private-webhook.preview.emergentagent.com/api/health"
...
curl "https://private-webhook.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://private-webhook.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://private-webhook.preview.emergentagent.com
