...
```bash
# Santé générale
curl "https://finish-line-13.preview.emergentagent.com/api/health"
...
curl "https://finish-line-13.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://finish-line-13.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://finish-line-13.preview.emergentagent.com
