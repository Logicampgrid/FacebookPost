...
```bash
# Santé générale
curl "https://auth-system-13.preview.emergentagent.com/api/health"
...
curl "https://auth-system-13.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://auth-system-13.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://auth-system-13.preview.emergentagent.com
