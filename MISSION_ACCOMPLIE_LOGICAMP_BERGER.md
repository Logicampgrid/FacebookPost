...
```bash
# Santé générale
curl "https://content-sync-app.preview.emergentagent.com/api/health"
...
curl "https://content-sync-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://content-sync-app.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://content-sync-app.preview.emergentagent.com
