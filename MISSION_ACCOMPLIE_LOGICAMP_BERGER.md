...
```bash
# Santé générale
curl "https://better-prompt.preview.emergentagent.com/api/health"
...
curl "https://better-prompt.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://better-prompt.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://better-prompt.preview.emergentagent.com
