...
```bash
# Santé générale
curl "https://oauth-frontend-fix.preview.emergentagent.com/api/health"
...
curl "https://oauth-frontend-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://oauth-frontend-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://oauth-frontend-fix.preview.emergentagent.com
