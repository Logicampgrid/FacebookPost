...
```bash
# Santé générale
curl "https://offline-lifestyle.preview.emergentagent.com/api/health"
...
curl "https://offline-lifestyle.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://offline-lifestyle.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://offline-lifestyle.preview.emergentagent.com
