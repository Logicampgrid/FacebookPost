...
```bash
# Santé générale
curl "https://codecraft-110.preview.emergentagent.com/api/health"
...
curl "https://codecraft-110.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://codecraft-110.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://codecraft-110.preview.emergentagent.com
