...
```bash
# Santé générale
curl "https://patch-master-8.preview.emergentagent.com/api/health"
...
curl "https://patch-master-8.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://patch-master-8.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://patch-master-8.preview.emergentagent.com
