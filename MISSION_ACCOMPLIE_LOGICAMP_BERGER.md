...
```bash
# Santé générale
curl "https://tunnel-gram.preview.emergentagent.com/api/health"
...
curl "https://tunnel-gram.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://tunnel-gram.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://tunnel-gram.preview.emergentagent.com
