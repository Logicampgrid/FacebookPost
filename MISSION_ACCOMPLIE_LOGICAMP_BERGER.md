...
```bash
# Santé générale
curl "https://token-exchange-5.preview.emergentagent.com/api/health"
...
curl "https://token-exchange-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://token-exchange-5.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://token-exchange-5.preview.emergentagent.com
