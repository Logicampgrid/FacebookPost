...
```bash
# Santé générale
curl "https://post-launcher-app.preview.emergentagent.com/api/health"
...
curl "https://post-launcher-app.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://post-launcher-app.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://post-launcher-app.preview.emergentagent.com
