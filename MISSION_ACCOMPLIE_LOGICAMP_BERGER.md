...
```bash
# Santé générale
curl "https://dual-boutique.preview.emergentagent.com/api/health"
...
curl "https://dual-boutique.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://dual-boutique.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://dual-boutique.preview.emergentagent.com
