...
```bash
# Santé générale
curl "https://auto-fb-publisher-1.preview.emergentagent.com/api/health"
...
curl "https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://auto-fb-publisher-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://auto-fb-publisher-1.preview.emergentagent.com
