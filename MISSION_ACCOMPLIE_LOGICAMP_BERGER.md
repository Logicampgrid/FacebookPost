...
```bash
# Santé générale
curl "https://bbs-video-post.preview.emergentagent.com/api/health"
...
curl "https://bbs-video-post.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://bbs-video-post.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://bbs-video-post.preview.emergentagent.com
