...
```bash
# Santé générale
curl "https://extend-url.preview.emergentagent.com/api/health"
...
curl "https://extend-url.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://extend-url.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://extend-url.preview.emergentagent.com
