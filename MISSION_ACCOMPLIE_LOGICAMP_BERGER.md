...
```bash
# Santé générale
curl "https://webhook-config.preview.emergentagent.com/api/health"
...
curl "https://webhook-config.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://webhook-config.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://webhook-config.preview.emergentagent.com
