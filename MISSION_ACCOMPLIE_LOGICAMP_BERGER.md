...
```bash
# Santé générale
curl "https://image-upload-fix-5.preview.emergentagent.com/api/health"
...
curl "https://image-upload-fix-5.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://image-upload-fix-5.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://image-upload-fix-5.preview.emergentagent.com
