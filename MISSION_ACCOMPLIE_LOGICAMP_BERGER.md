...
```bash
# Santé générale
curl "https://social-media-sync-1.preview.emergentagent.com/api/health"
...
curl "https://social-media-sync-1.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://social-media-sync-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://social-media-sync-1.preview.emergentagent.com
