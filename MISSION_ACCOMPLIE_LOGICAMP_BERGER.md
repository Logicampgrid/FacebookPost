...
```bash
# Santé générale
curl "https://prompt-architect-14.preview.emergentagent.com/api/health"
...
curl "https://prompt-architect-14.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://prompt-architect-14.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://prompt-architect-14.preview.emergentagent.com
