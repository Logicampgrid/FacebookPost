...
```bash
# Santé générale
curl "https://ngrok-detect.preview.emergentagent.com/api/health"
...
curl "https://ngrok-detect.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://ngrok-detect.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://ngrok-detect.preview.emergentagent.com
