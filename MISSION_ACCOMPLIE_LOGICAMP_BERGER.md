...
```bash
# Santé générale
curl "https://upload-guard.preview.emergentagent.com/api/health"
...
curl "https://upload-guard.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://upload-guard.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://upload-guard.preview.emergentagent.com
