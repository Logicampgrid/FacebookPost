...
```bash
# Santé générale
curl "https://img-post-fix.preview.emergentagent.com/api/health"
...
curl "https://img-post-fix.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://img-post-fix.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://img-post-fix.preview.emergentagent.com
