...
1. **🌐 Ouvrez l'interface :**
   ```
   https://berger-blanc-suisse.preview.emergentagent.com
   ```
...
```bash
# Santé générale
curl "https://berger-blanc-suisse.preview.emergentagent.com/api/health"
...
curl "https://berger-blanc-suisse.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://berger-blanc-suisse.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://berger-blanc-suisse.preview.emergentagent.com
