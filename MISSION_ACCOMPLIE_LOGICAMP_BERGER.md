...
```bash
# Santé générale
curl "https://frontend-access.preview.emergentagent.com/api/health"
...
curl "https://frontend-access.preview.emergentagent.com/api/webhook-history?shop_type=gizmobbs"

# Diagnostic Instagram complet
curl "https://frontend-access.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Authentifiez-vous** : https://frontend-access.preview.emergentagent.com
