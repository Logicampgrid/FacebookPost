...
async def test_conversion():
    ...
    for i, test_path in enumerate(test_paths, 1):
        ...
        try:
            ...
            if converted_url.startswith('https://senior-engineer-1.preview.emergentagent.com'):
    ...
    try:
        ...
        if result_url.startswith('https://senior-engineer-1.preview.emergentagent.com'):
