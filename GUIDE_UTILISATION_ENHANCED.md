...
```bash
curl -X POST https://instapost-update.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://instapost-update.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://instapost-update.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://instapost-update.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://instapost-update.preview.emergentagent.com/api/webhook
```
