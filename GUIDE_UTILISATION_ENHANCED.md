...
```bash
curl -X POST https://dev-ai-helper-1.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://dev-ai-helper-1.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced-upload
```
