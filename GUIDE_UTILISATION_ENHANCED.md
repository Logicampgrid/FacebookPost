...
```bash
curl -X POST https://smart-prompt-5.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://smart-prompt-5.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced-upload
```
