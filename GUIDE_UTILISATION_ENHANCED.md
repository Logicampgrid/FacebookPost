...
```bash
curl -X POST https://prompt-engineer-14.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://prompt-engineer-14.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://prompt-engineer-14.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://prompt-engineer-14.preview.emergentagent.com/api/webhook/enhanced-upload
```
