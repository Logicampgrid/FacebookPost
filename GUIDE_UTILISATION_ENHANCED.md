...
```bash
curl -X POST https://code-compiler-check.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://code-compiler-check.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://code-compiler-check.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://code-compiler-check.preview.emergentagent.com/api/webhook/enhanced-upload
```
