...
```bash
curl -X POST https://instagram-upload.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://instagram-upload.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://instagram-upload.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://instagram-upload.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://instagram-upload.preview.emergentagent.com/api/webhook
```
...
```bash
# Vérifier le statut
curl https://instagram-upload.preview.emergentagent.com/api/health
```
