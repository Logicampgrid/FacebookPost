...
```bash
curl -X POST https://code-mentor-pro.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://code-mentor-pro.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced-upload
```
