...
```bash
curl -X POST https://ai-code-helper-4.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://ai-code-helper-4.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced-upload
```
