...
```bash
curl -X POST https://ai-prompt-tool-1.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://ai-prompt-tool-1.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://ai-prompt-tool-1.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://ai-prompt-tool-1.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://ai-prompt-tool-1.preview.emergentagent.com/api/webhook
```
...
```bash
# Vérifier le statut
curl https://ai-prompt-tool-1.preview.emergentagent.com/api/health
```
