...
```bash
curl -X POST https://emergent-n8n-fix.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://emergent-n8n-fix.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://emergent-n8n-fix.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://emergent-n8n-fix.preview.emergentagent.com/api/webhook/enhanced-upload
```
