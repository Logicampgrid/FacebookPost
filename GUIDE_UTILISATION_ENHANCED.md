...
```bash
curl -X POST https://prompt-enhance-5.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://prompt-enhance-5.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://prompt-enhance-5.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://prompt-enhance-5.preview.emergentagent.com/api/webhook/enhanced-upload
```
