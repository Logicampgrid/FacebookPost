...
```bash
curl -X POST https://social-post-enhancer.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://social-post-enhancer.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://social-post-enhancer.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://social-post-enhancer.preview.emergentagent.com/api/webhook/enhanced-upload
```
