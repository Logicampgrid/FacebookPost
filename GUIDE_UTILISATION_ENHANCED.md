...
```bash
curl -X POST https://auto-ngrok-updater.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://auto-ngrok-updater.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://auto-ngrok-updater.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://auto-ngrok-updater.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://auto-ngrok-updater.preview.emergentagent.com/api/webhook
```
