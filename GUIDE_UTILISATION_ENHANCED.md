...
```bash
curl -X POST https://promptgenius-13.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://promptgenius-13.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://promptgenius-13.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://promptgenius-13.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://promptgenius-13.preview.emergentagent.com/api/webhook
```
