...
```bash
curl -X POST https://prod-sync-fix.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://prod-sync-fix.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://prod-sync-fix.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://prod-sync-fix.preview.emergentagent.com/api/webhook/enhanced-upload
```
