...
```bash
curl -X POST https://fbpost-backfix.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://fbpost-backfix.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced-upload
```
