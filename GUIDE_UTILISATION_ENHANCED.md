...
```bash
curl -X POST https://smartprompt-7.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://smartprompt-7.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://smartprompt-7.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://smartprompt-7.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://smartprompt-7.preview.emergentagent.com/api/webhook
```
