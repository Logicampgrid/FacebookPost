...
```bash
curl -X POST https://fb-media-manager.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://fb-media-manager.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://fb-media-manager.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://fb-media-manager.preview.emergentagent.com/api/webhook/enhanced-upload
```
