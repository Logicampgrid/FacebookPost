...
```bash
curl -X POST https://webpub-debug.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://webpub-debug.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://webpub-debug.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://webpub-debug.preview.emergentagent.com/api/webhook/enhanced-upload
```
