...
```bash
curl -X POST https://code-wizard-34.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://code-wizard-34.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://code-wizard-34.preview.emergentagent.com/api/webhook
```
