...
```bash
curl -X POST https://patch-master-8.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://patch-master-8.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://patch-master-8.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://patch-master-8.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://patch-master-8.preview.emergentagent.com/api/webhook
```
