...
```bash
curl -X POST https://prompt-wizard-156.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://prompt-wizard-156.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://prompt-wizard-156.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://prompt-wizard-156.preview.emergentagent.com/api/webhook/enhanced-upload
```
