...
```bash
curl -X POST https://code-craftsman-57.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://code-craftsman-57.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://code-craftsman-57.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://code-craftsman-57.preview.emergentagent.com/api/webhook/enhanced-upload
```
