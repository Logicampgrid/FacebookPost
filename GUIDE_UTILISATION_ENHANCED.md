...
```bash
curl -X POST https://insta-auto-fix.preview.emergentagent.com/api/test/enhanced-upload
```

### Information Détaillée
```bash
curl https://insta-auto-fix.preview.emergentagent.com/api/enhanced-upload-info
```

### Test Webhook N8N
```bash
curl -X POST https://insta-auto-fix.preview.emergentagent.com/api/webhook/enhanced-upload \
...
```
https://insta-auto-fix.preview.emergentagent.com/api/webhook/enhanced-upload
```

### Option 2: Transition Graduelle  
Gardez votre URL actuelle :
```
https://insta-auto-fix.preview.emergentagent.com/api/webhook
```
