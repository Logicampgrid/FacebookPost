...
```
POST https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct
```
...
```
POST https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct/test
```
...
```
POST https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct/setup-test-user
DELETE https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct/cleanup-test-user
```

## 🔧 **Configuration N8N**

### Étape 1 : Créer un webhook HTTP Request
1. **URL** : `https://auto-fb-publisher-1.preview.emergentagent.com/api/publishProduct`
2. **Méthode** : `POST`
3. **Headers** :
   ```
