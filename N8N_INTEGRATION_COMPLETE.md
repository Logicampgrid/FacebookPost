...
```
POST https://ok-confirm-5.preview.emergentagent.com/api/publishProduct/setup-test-user
DELETE https://ok-confirm-5.preview.emergentagent.com/api/publishProduct/cleanup-test-user
```

## 🔧 **Configuration N8N**

### Étape 1 : Créer un webhook HTTP Request
1. **URL** : `https://ok-confirm-5.preview.emergentagent.com/api/publishProduct`
2. **Méthode** : `POST`
3. **Headers** :
   ```
