...
```
POST https://link-image-debug.preview.emergentagent.com/api/publishProduct
```
...
```
POST https://link-image-debug.preview.emergentagent.com/api/publishProduct/test
```
...
```
POST https://link-image-debug.preview.emergentagent.com/api/publishProduct/setup-test-user
DELETE https://link-image-debug.preview.emergentagent.com/api/publishProduct/cleanup-test-user
```

## 🔧 **Configuration N8N**

### Étape 1 : Créer un webhook HTTP Request
1. **URL** : `https://link-image-debug.preview.emergentagent.com/api/publishProduct`
2. **Méthode** : `POST`
3. **Headers** :
   ```
