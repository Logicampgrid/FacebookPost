...
```
POST https://preview-app-38.preview.emergentagent.com/api/publishProduct/setup-test-user
DELETE https://preview-app-38.preview.emergentagent.com/api/publishProduct/cleanup-test-user
```

## 🔧 **Configuration N8N**

### Étape 1 : Créer un webhook HTTP Request
1. **URL** : `https://preview-app-38.preview.emergentagent.com/api/publishProduct`
2. **Méthode** : `POST`
3. **Headers** :
   ```
...
```bash
curl -X POST "https://preview-app-38.preview.emergentagent.com/api/publishProduct" \
