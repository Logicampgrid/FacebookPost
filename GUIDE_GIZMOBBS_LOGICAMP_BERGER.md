...
### **Endpoint Principal**
```
POST https://ok-system-7.preview.emergentagent.com/api/webhook
```
...
{
  "method": "POST",
  "url": "https://ok-system-7.preview.emergentagent.com/api/publishProduct",
  "headers": {
...
```bash
curl -X POST "https://ok-system-7.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```

### **Diagnostic Instagram Complet**
```bash
curl -X GET "https://ok-system-7.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Vérifier l'authentification :**
   ```bash
   curl -X GET "https://ok-system-7.preview.emergentagent.com/api/health"
