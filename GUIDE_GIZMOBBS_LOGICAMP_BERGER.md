...
### **Endpoint Principal**
```
POST https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook
```
...
```bash
curl -X POST "https://auto-fb-publisher-1.preview.emergentagent.com/api/debug/test-logicamp-berger-webhook"
```

### **Test Configuration Gizmobbs**
```bash
curl -X POST "https://auto-fb-publisher-1.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```

### **Diagnostic Instagram Complet**
```bash
curl -X GET "https://auto-fb-publisher-1.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Vérifier l'authentification :**
   ```bash
   curl -X GET "https://auto-fb-publisher-1.preview.emergentagent.com/api/health"
