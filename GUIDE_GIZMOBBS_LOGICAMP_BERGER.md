...
### **Endpoint Principal**
```
POST https://berger-blanc-suisse.preview.emergentagent.com/api/webhook
```
...
```bash
curl -X POST "https://berger-blanc-suisse.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```
