...
### **Endpoint Principal**
```
POST https://insta-tunnel-free.preview.emergentagent.com/api/webhook
```
...
```bash
curl -X POST "https://insta-tunnel-free.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```
