...
### **Endpoint Principal**
```
POST https://insta-uploader.preview.emergentagent.com/api/webhook
```
...
{
  "method": "POST",
  "url": "https://insta-uploader.preview.emergentagent.com/api/publishProduct",
  "headers": {
...
```bash
curl -X POST "https://insta-uploader.preview.emergentagent.com/api/debug/test-logicamp-berger-webhook"
```

### **Test Configuration Gizmobbs**
```bash
curl -X POST "https://insta-uploader.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```

### **Diagnostic Instagram Complet**
```bash
curl -X GET "https://insta-uploader.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Se connecter via l'interface web :**
   ```
   https://insta-uploader.preview.emergentagent.com
   ```
...
1. **Vérifier l'authentification :**
   ```bash
   curl -X GET "https://insta-uploader.preview.emergentagent.com/api/health"
