...
### **Endpoint Principal**
```
POST https://ngrok-detector.preview.emergentagent.com/api/webhook
```
...
```bash
curl -X POST "https://ngrok-detector.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```

### **Diagnostic Instagram Complet**
```bash
curl -X GET "https://ngrok-detector.preview.emergentagent.com/api/debug/instagram-complete-diagnosis"
```
...
1. **Vérifier l'authentification :**
   ```bash
   curl -X GET "https://ngrok-detector.preview.emergentagent.com/api/health"
