...
### **Endpoint Principal**
```
POST https://insta-post-fixer.preview.emergentagent.com/api/webhook
```
...
```bash
curl -X POST "https://insta-post-fixer.preview.emergentagent.com/api/debug/test-multi-platform-post?shop_type=gizmobbs"
```
