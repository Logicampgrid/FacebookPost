...
```
POST https://dual-boutique.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://dual-boutique.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://dual-boutique.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://dual-boutique.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://dual-boutique.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://dual-boutique.preview.emergentagent.com/api/webhook/enhanced"
```
