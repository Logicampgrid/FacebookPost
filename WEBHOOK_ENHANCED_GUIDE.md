...
```
POST https://video-post-feature.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://video-post-feature.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://video-post-feature.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://video-post-feature.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://video-post-feature.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://video-post-feature.preview.emergentagent.com/api/webhook/enhanced"
```
