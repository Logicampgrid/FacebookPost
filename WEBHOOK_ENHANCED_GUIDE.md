...
```
POST https://social-autopub.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://social-autopub.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://social-autopub.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://social-autopub.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://social-autopub.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://social-autopub.preview.emergentagent.com/api/webhook/enhanced"
```
