...
```
POST https://emergent-upgrade.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://emergent-upgrade.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://emergent-upgrade.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://emergent-upgrade.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://emergent-upgrade.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://emergent-upgrade.preview.emergentagent.com/api/webhook/enhanced"
```
