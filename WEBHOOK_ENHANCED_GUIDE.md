...
```
POST https://social-media-fix-1.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://social-media-fix-1.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://social-media-fix-1.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://social-media-fix-1.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://social-media-fix-1.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://social-media-fix-1.preview.emergentagent.com/api/webhook/enhanced"
```
