...
```
POST https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://fbpost-backfix.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://fbpost-backfix.preview.emergentagent.com/api/webhook/enhanced"
```
