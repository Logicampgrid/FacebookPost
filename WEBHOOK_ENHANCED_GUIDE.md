...
```
POST https://fb-webhook-local.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://fb-webhook-local.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://fb-webhook-local.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://fb-webhook-local.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://fb-webhook-local.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://fb-webhook-local.preview.emergentagent.com/api/webhook/enhanced"
```
