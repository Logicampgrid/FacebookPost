...
```
POST https://finish-line-13.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://finish-line-13.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://finish-line-13.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://finish-line-13.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://finish-line-13.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://finish-line-13.preview.emergentagent.com/api/webhook/enhanced"
```
