...
```
POST https://hors-instagram.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://hors-instagram.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://hors-instagram.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://hors-instagram.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://hors-instagram.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://hors-instagram.preview.emergentagent.com/api/webhook/enhanced"
```
