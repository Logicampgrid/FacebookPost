...
```
POST https://photo-path-converter.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://photo-path-converter.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://photo-path-converter.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://photo-path-converter.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://photo-path-converter.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://photo-path-converter.preview.emergentagent.com/api/webhook/enhanced"
```
