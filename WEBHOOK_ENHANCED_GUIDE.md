...
```
POST https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://code-wizard-34.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://code-wizard-34.preview.emergentagent.com/api/webhook/enhanced"
```
