...
```
POST https://facebookpost-app.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://facebookpost-app.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://facebookpost-app.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://facebookpost-app.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://facebookpost-app.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://facebookpost-app.preview.emergentagent.com/api/webhook/enhanced"
```
