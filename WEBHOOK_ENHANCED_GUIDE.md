...
```
POST https://instagram-diag.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://instagram-diag.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://instagram-diag.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://instagram-diag.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://instagram-diag.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://instagram-diag.preview.emergentagent.com/api/webhook/enhanced"
```
