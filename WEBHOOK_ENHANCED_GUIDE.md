...
```
POST https://offline-lifestyle.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://offline-lifestyle.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://offline-lifestyle.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://offline-lifestyle.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://offline-lifestyle.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://offline-lifestyle.preview.emergentagent.com/api/webhook/enhanced"
```
