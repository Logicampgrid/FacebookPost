...
```
POST https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://auto-fb-publisher-1.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://auto-fb-publisher-1.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
