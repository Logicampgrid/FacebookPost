...
```
POST https://blank-ngrok.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://blank-ngrok.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://blank-ngrok.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://blank-ngrok.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://blank-ngrok.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://blank-ngrok.preview.emergentagent.com/api/webhook/enhanced"
```
