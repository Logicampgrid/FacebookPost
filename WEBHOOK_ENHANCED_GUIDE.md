...
```
POST https://product-share-hub.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://product-share-hub.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://product-share-hub.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://product-share-hub.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://product-share-hub.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://product-share-hub.preview.emergentagent.com/api/webhook/enhanced"
```
