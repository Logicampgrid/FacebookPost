...
```
POST https://bbs-video-post.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://bbs-video-post.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://bbs-video-post.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://bbs-video-post.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://bbs-video-post.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://bbs-video-post.preview.emergentagent.com/api/webhook/enhanced"
```
