...
```
POST https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://fb-insta-publisher.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://fb-insta-publisher.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
