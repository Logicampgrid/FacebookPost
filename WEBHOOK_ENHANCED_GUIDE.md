...
```
POST https://upload-guard.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://upload-guard.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://upload-guard.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://upload-guard.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://upload-guard.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://upload-guard.preview.emergentagent.com/api/webhook/enhanced"
```
