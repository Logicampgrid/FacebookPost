...
```
POST https://carry-on-174.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://carry-on-174.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://carry-on-174.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://carry-on-174.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://carry-on-174.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://carry-on-174.preview.emergentagent.com/api/webhook/enhanced"
```
