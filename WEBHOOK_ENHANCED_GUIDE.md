...
```
POST https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://facebook-auth-fix-1.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://facebook-auth-fix-1.preview.emergentagent.com/api/webhook/enhanced"
```
