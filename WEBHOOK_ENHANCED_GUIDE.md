...
```
POST https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://ngrok-fb-publisher.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://ngrok-fb-publisher.preview.emergentagent.com/api/webhook/enhanced"
```
