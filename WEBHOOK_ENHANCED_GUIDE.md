...
```
POST https://smart-fb-poster.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://smart-fb-poster.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://smart-fb-poster.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://smart-fb-poster.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://smart-fb-poster.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://smart-fb-poster.preview.emergentagent.com/api/webhook/enhanced"
```
