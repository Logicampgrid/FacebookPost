...
```
POST https://instapost-update.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://instapost-update.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://instapost-update.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://instapost-update.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://instapost-update.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://instapost-update.preview.emergentagent.com/api/webhook/enhanced"
```
