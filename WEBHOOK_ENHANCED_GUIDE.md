...
```
POST https://gizmobbs-media-api.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://gizmobbs-media-api.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://gizmobbs-media-api.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://gizmobbs-media-api.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://gizmobbs-media-api.preview.emergentagent.com/api/webhook/enhanced" \
