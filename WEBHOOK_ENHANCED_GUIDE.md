...
```
POST https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://tunnel-gram.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://tunnel-gram.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
