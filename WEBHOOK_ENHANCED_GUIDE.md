...
```
POST https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://ai-code-helper-4.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://ai-code-helper-4.preview.emergentagent.com/api/webhook/enhanced"
```
