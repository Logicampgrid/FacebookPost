...
```
POST https://crosspost-oauth.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://crosspost-oauth.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://crosspost-oauth.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://crosspost-oauth.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://crosspost-oauth.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://crosspost-oauth.preview.emergentagent.com/api/webhook/enhanced"
```
