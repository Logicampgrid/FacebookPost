...
```
POST https://insta-uploader.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://insta-uploader.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://insta-uploader.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://insta-uploader.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://insta-uploader.preview.emergentagent.com/api/webhook/enhanced" \
