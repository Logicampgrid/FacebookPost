...
```
POST https://fb-graph-updater.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://fb-graph-updater.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://fb-graph-updater.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://fb-graph-updater.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://fb-graph-updater.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://fb-graph-updater.preview.emergentagent.com/api/webhook/enhanced"
```
