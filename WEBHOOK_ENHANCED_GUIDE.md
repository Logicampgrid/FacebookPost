...
```
POST https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://code-mentor-pro.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://code-mentor-pro.preview.emergentagent.com/api/webhook/enhanced"
```
