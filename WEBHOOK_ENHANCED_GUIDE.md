...
```
POST https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://facebook-poster.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://facebook-poster.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
