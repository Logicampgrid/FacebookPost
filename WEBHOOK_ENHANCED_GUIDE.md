...
```
POST https://ok-system-7.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://ok-system-7.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://ok-system-7.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://ok-system-7.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://ok-system-7.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://ok-system-7.preview.emergentagent.com/api/webhook/enhanced"
```
