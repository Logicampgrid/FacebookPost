...
```
POST https://continue-app-45.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://continue-app-45.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://continue-app-45.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://continue-app-45.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://continue-app-45.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://continue-app-45.preview.emergentagent.com/api/webhook/enhanced"
```
