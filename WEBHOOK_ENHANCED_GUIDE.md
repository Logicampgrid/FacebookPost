...
```
POST https://social-domain-fix.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://social-domain-fix.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://social-domain-fix.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://social-domain-fix.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://social-domain-fix.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://social-domain-fix.preview.emergentagent.com/api/webhook/enhanced"
```
