...
```
POST https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://smart-prompt-5.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://smart-prompt-5.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
