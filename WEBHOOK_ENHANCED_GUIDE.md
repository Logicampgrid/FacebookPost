...
```
POST https://insta-post-fixer.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://insta-post-fixer.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://insta-post-fixer.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://insta-post-fixer.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://insta-post-fixer.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://insta-post-fixer.preview.emergentagent.com/api/webhook/enhanced"
```
