...
```
POST https://promptbot-1.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://promptbot-1.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://promptbot-1.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://promptbot-1.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://promptbot-1.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://promptbot-1.preview.emergentagent.com/api/webhook/enhanced"
```
