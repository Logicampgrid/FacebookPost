...
```
POST https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://berger-blanc-suisse.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://berger-blanc-suisse.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
