...
```
POST https://prompt-enhance-4.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://prompt-enhance-4.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://prompt-enhance-4.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://prompt-enhance-4.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://prompt-enhance-4.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://prompt-enhance-4.preview.emergentagent.com/api/webhook/enhanced"
```
