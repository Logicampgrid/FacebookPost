...
```
POST https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://media-converter-6.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://media-converter-6.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
