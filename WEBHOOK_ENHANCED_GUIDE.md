...
```
POST https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://meta-publish-server.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://meta-publish-server.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
