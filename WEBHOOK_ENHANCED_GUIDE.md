...
```
POST https://media-post.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://media-post.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://media-post.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://media-post.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://media-post.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://media-post.preview.emergentagent.com/api/webhook/enhanced"
```
