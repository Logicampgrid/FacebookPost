...
```
POST https://image-upload-fix-5.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://image-upload-fix-5.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://image-upload-fix-5.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://image-upload-fix-5.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://image-upload-fix-5.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://image-upload-fix-5.preview.emergentagent.com/api/webhook/enhanced"
```
