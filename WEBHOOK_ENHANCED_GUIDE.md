...
```
POST https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://social-media-fixer.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced"
```
...
1. **Parameters**:
   - **Method**: `POST`
   - **URL**: `https://social-media-fixer.preview.emergentagent.com/api/webhook/enhanced`
   - **Authentication**: None
   - **Send Body**: Yes
