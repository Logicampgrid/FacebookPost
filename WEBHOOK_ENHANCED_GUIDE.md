...
```
POST https://logicamp-ftp.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://logicamp-ftp.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://logicamp-ftp.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://logicamp-ftp.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://logicamp-ftp.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://logicamp-ftp.preview.emergentagent.com/api/webhook/enhanced"
```
