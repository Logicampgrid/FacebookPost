...
```
POST https://login-gateway-fix.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://login-gateway-fix.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://login-gateway-fix.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://login-gateway-fix.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://login-gateway-fix.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://login-gateway-fix.preview.emergentagent.com/api/webhook/enhanced"
```
