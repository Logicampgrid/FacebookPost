...
```
POST https://connection-failed.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://connection-failed.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://connection-failed.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://connection-failed.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://connection-failed.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://connection-failed.preview.emergentagent.com/api/webhook/enhanced"
```
