...
```
POST https://ecu-corrector.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://ecu-corrector.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://ecu-corrector.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://ecu-corrector.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://ecu-corrector.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://ecu-corrector.preview.emergentagent.com/api/webhook/enhanced"
```
