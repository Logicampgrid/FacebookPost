...
```
POST https://social-login-app.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://social-login-app.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://social-login-app.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://social-login-app.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://social-login-app.preview.emergentagent.com/api/webhook/enhanced" \
