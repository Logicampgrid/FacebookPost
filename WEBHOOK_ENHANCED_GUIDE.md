...
```
POST https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced
...
```
GET https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced
```
...
1. **Method**: `POST`
2. **URL**: `https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced`
...
```json
{
  ...
  "data": {
    ...
    "generated_image_url": "https://dev-ai-helper-1.preview.emergentagent.com/api/uploads/xxx.jpg",
...
curl -X POST "https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced" \
...
```bash
curl -X GET "https://dev-ai-helper-1.preview.emergentagent.com/api/webhook/enhanced"
```
